...
import {
    ...
    a as h,
    b as a1
} from "./level3-2267c79e.js";
var n1 = l('<table class="mt-4 w-full rounded-lg bg-layer3 text-center"><thead class=text-secondary><tr><th class="px-3 py-2 text-left"></th><th class="px-3 py-2"></th><th class="px-3 py-2 text-right"></th></tr></thead><tbody>'),
    i1 = l('<tr><td class="flex items-center justify-start gap-1 p-3"><img class="h-5 w-4"><span></span></td><td class=p-3></td><td class="flex items-center justify-end gap-1 p-3"><img class="h-4 w-4"><span class="font-extrabold text-brand">');
const r1 = function() {
    const a = [{
        icon: u,
        Level: "VIP 04",
    ...
    return (() => {
        var r = n1(),
            ...
            S = p.nextSibling,
            R = d.nextSibling;
        return e(x, () => t("Friend’s Level")), e(p, () => t("Total Wager")), e(S, () => t("Unlock Amount")), e(R, s(t1, {
            each: a,
            children: o => (() => {
                var m = i1(),
                    f = m.firstChild,
...
const I1 = function() {
        const a = e1(),
            {
                isUsHost: r
            } = Ne.getHostType(oe.host),
            [d, y] = g(a.rule === "open"),
            x = [
                [() => t("Original Games (28%)"), .28],
                [() => t("Live Casino (60%)"), .6],
                [() => t("3rd Party Slots (60%)"), .6],
                [() => t("Sport Games (100%)"), 1]
            ],
            [p, S] = g(1e3),
            [R, o] = g(""),
            ...
            n = () => ({
                wager: 0,
                MinWagerMessage: r ? t("Minimum 1 SC") : t("Minimum 1 USDT"),
                MaxWagerMessage: r ? t("Maximum 10,000,000 SC") : t("Maximum 10,000,000 USDT"),
                commissionRate: 0,
                MinCommissionRateMessage: t("Minimum 1%"),
                MaxCommissionRateMessage: t("Range 1% - 100%")
            }),
            L = () => {
                n().wager || n().commissionRate;
                const v = C()[1];
                o(new $(p()).times(new $(m())).div(1e4).times(new $(v)).toFixed(2, $.ROUND_DOWN))
            };
        s1(() => {
            L()
        });
        ...
        return (() => {
            var v = b1(),
                ...
                Fe = Oe.firstChild,
                Ke = Fe.nextSibling;
            return e(A, () => t("Commission Reward Rate")), e(O, () => t("Casino")), e(N, () => t("The Original Games")), e(Y, () => t("Wager")), e(be, () => t("Commission Rate")), e(E, () => t("3rd Party Slots, Live Casino")), e(q, () => t("Wager")), e(he, () => t("Commission Rate")), e(z, () => t("All Sports")), e(J, () => t("Wager")), e(Re, () => t("Commission Rate")), e(Q, s(Ye, {
                get when() {
                    return d()
                },
                get children() {
                ...
                get children() {
                    return [(() => {
                        ...
                        name: "Arrow",
                        get class() {
                            return `ml-1 w-4 -rotate-90 text-secondary transition-all ${d()?"rotate-90":""}`
                        }
                    })]
                }
            }), null), e(P, s(h1, {}), ee), e(ee, () => t("Commission Calculator")), e(Ie, r ? "SC" : "USDT"), e(V, () => t("Wager"), Ve), e(V, `(${r?"SC":"USDT"})`, null), e(_, s(ce, {
                min: b,
                max: I,
                get value() {
                    return p()
                ...
                get children() {
                    ...
                    return e(i, (() => {
                        var H = re(() => n().wager === 1);
                        return () => H() ? n().MinWagerMessage : n().MaxWagerMessage
                    })()), i
                }
            }), null), e(We, () => t("Commission Rate")), e(T, s(ce, {
                min: Ce,
                max: ge,
                get value() {
                    return m()
                ...
                get children() {
                    var i = xe();
                    return e(i, (() => {
                        var H = re(() => n().commissionRate === 1);
                        return () => H() ? n().MinCommissionRateMessage : n().MaxCommissionRateMessage
                    })()), i
                }
            }), null), e(De, () => t("Game")), e(W, s(Je, {
                ...
                options: x,
                children: i => i()[0]()
            }), null), e(D, R, Ge), e(D, r ? "SC" : "USDT", null), e(ae, () => t("How to Get your Referral Reward")), e(je, s(U, {
            ...
            })), e(le, s(r1, {}), null), pe(() => Z(te, "src", Qe.coinIcon(r ? "SC" : "USDT"))), v
        })()
    },
    me = function() {
        return [(() => {
            var a = w();
            return e(a, () => t("In any public environment (eg, universities, schools, libraries, and office spaces), only one commission can be paid to each user, IP address, electronic device, home, phone number, billing method, email address, and computer and IP address shared with others.")), a
        })(), (() => {
            var a = w();
            return e(a, () => t("Our decision to draw a bet will be based entirely on our discretion after a deposit is made and a bet is successfully placed.")), a
        })(), (() => {
            var a = w();
            return e(a, () => t("We support the majority of currencies on the market. Commissions can be withdrawn into our internal BCgame wallet at anytime. (View your commission extraction in the dashboard and view the balance in the wallet).")), a
        })(), (() => {
            var a = w();
            return e(a, () => t("The system calculates the commission every 24 hours.")), a
        })()]
    };
