...
var L = (g, v, r) => v in g ? R(g, v, {
    ...
    E = (g, v) => {
        ...
        if (F)
            for (var r of F(v)) q.call(v, r) && L(g, r, v[r]);
        return g
    };
import {
    j as I
...
(function(g) {
    (function() {
        ...
        v.prototype = {
            ...
            volume: function(e) {
                var t = this || r;
                if (e = parseFloat(e), t.ctx || w(), typeof e != "undefined" && e >= 0 && e <= 1) {
                    ...
                    var t = function(n) {
                        ...
                        for (var u = 0; u < e._howls.length; u++)
                            if (!e._howls[u]._webAudio)
                                for (var s = e._howls[u]._getSoundIds(), a = 0; a < s.length; a++) {
                        ...
                        m.buffer = e._scratchBuffer, m.connect(e.ctx.destination), typeof m.start == "undefined" ? m.noteOn(0) : m.start(0), typeof e.ctx.resume == "function" && e.ctx.resume(), m.onended = function() {
                            ...
                            for (var A = 0; A < e._howls.length; A++) e._howls[A]._emit("unlock")
                        }
                    };
        ...
        l.prototype = {
            ...
            play: function(e, t) {
                ...
                if (typeof e == "number") o = e, e = null;
                    ...
                    if (typeof e == "undefined" && (e = "__default", !n._playLock)) {
                        for (var u = 0, s = 0; s < n._sounds.length; s++) n._sounds[s]._paused && !n._sounds[s]._ended && (u++, o = n._sounds[s]._id);
                        u === 1 ? e = null : o = null
                    }
                }
                ...
                a._sprite = e, a._ended = !1;
                var H = function() {
                    a._paused = !1, a._seek = m, a._start = T, a._stop = k, a._loop = !!(a._loop || n._sprite[e][2])
                };
                if (m >= k) {
                    n._ended(a);
                    return
                ...
                if (n._webAudio) {
                    ...
                    r.state === "running" && r.ctx.state !== "interrupted" ? P() : (n._playLock = !0, n.once("resume", P), n._clearTimer(a._id))
                } else {
                    var M = function() {
                        h.currentTime = m, h.muted = a._muted || n._muted || r._muted || h.muted, h.volume = a._volume * r.volume(), h.playbackRate = a._rate;
                        try {
                            var x = h.play();
                            if (x && typeof Promise != "undefined" && (x instanceof Promise || typeof x.then == "function") ? (n._playLock = !0, H(), x.then(function() {
                                ...
                                })) : t || (n._playLock = !1, H(), n._emit("play", a._id)), h.playbackRate = a._rate, h.paused) {
                            ...
                            e !== "__default" || a._loop ? n._endTimers[a._id] = setTimeout(n._ended.bind(n, a), b) : (n._endTimers[a._id] = function() {
                    ...
                    var V = window && window.ejecta || !h.readyState && r._navigator.isCocoonJS;
                    if (h.readyState >= 3 || V) M();
                    else {
                        n._playLock = !0, n._state = "loading";
                        var B = function() {
                            n._state = "loaded", M(), h.removeEventListener(r._canPlayEvent, B, !1)
                        };
                ...
                for (var n = t._getSoundIds(e), o = 0; o < n.length; o++) {
                    ...
                    if (u && !u._paused && (u._seek = t.seek(n[o]), u._rateSeek = 0, u._paused = !0, t._stopFade(n[o]), u._node))
                        if (t._webAudio) {
                            ...
                            typeof u._node.bufferSource.stop == "undefined" ? u._node.bufferSource.noteOff(0) : u._node.bufferSource.stop(0), t._cleanBuffer(u._node)
            ...
            stop: function(e, t) {
                ...
                for (var o = n._getSoundIds(e), u = 0; u < o.length; u++) {
                    ...
                    s && (s._seek = s._start || 0, s._rateSeek = 0, s._paused = !0, s._ended = !0, n._stopFade(o[u]), s._node && (n._webAudio ? s._node.bufferSource && (typeof s._node.bufferSource.stop == "undefined" ? s._node.bufferSource.noteOff(0) : s._node.bufferSource.stop(0), n._cleanBuffer(s._node)) : (!isNaN(s._node.duration) || s._node.duration === 1 / 0) && (s._node.currentTime = s._start || 0, s._node.pause(), s._node.duration === 1 / 0 && n._clearSound(s._node))), t || n._emit("stop", s._id))
                }
                return n
            },
            mute: function(e, t) {
                    ...
                    if (f) {
                        if (o || u._stopFade(s[a]), u._webAudio && !f._muted) {
                            var m = r.ctx.currentTime,
                                A = m + n / 1e3;
                            f._volume = e, f._node.gain.setValueAtTime(e, m), f._node.gain.linearRampToValueAtTime(t, A)
                        }
            ...
            _startFadeInterval: function(e, t, n, o, u, s) {
                ...
                e._fadeTo = n, e._interval = setInterval(function() {
                    var k = (Date.now() - T) / o;
                    T = Date.now(), f += m * k, f = Math.round(f * 100) / 100, m < 0 ? f = Math.max(n, f) : f = Math.min(n, f), a._webAudio ? e._volume = f : a.volume(f, e._id, !0), s && (a._volume = f), (n < t && f <= n || n > t && f >= n) && (clearInterval(e._interval), e._interval = null, e._fadeTo = null, a.volume(n, e._id), a._emit("fade", e._id))
                }, b)
            },
            ...
            loop: function() {
                ...
                for (var s = e._getSoundIds(o), a = 0; a < s.length; a++) u = e._soundById(s[a]), u && (u._loop = n, e._webAudio && u._node && u._node.bufferSource && (u._node.bufferSource.loop = n, n && (u._node.bufferSource.loopStart = u._start || 0, u._node.bufferSource.loopEnd = u._stop, e.playing(s[a]) && (e.pause(s[a], !0), e.play(s[a], !0)))));
                return e
            },
            rate: function() {
                var e = this,
                ...
                if (typeof n == "number") {
                    ...
                    for (var f = 0; f < o.length; f++)
                        if (a = e._soundById(o[f]), a) {
                            ...
                            var m = e.seek(o[f]),
                                A = (e._sprite[a._sprite][0] + e._sprite[a._sprite][1]) / 1e3 - m,
                                b = A * 1e3 / Math.abs(a._rate);
                            (e._endTimers[o[f]] || !a._paused) && (e._clearTimer(o[f]), e._endTimers[o[f]] = setTimeout(e._ended.bind(e, a), b)), e._emit("rate", a._id)
                        }
            ...
            on: function(e, t, n, o) {
                var u = this,
                    s = u["_on" + e];
                return typeof t == "function" && s.push(o ? {
                    id: n,
                    fn: t,
                    once: o
                } : {
            ...
            off: function(e, t, n) {
                ...
                if (typeof t == "number" && (n = t, t = null), t || n)
                    for (s = 0; s < u.length; s++) {
                        ...
                        var f = Object.keys(o);
                        for (s = 0; s < f.length; s++) f[s].indexOf("_on") === 0 && Array.isArray(o[f[s]]) && (o[f[s]] = [])
                    }
                return o
            },
            once: function(e, t, n) {
            ...
            _emit: function(e, t, n) {
                for (var o = this, u = o["_on" + e], s = u.length - 1; s >= 0; s--)(!u[s].id || u[s].id === t || e === "load") && (setTimeout(function(a) {
                    a.call(this, t, n)
        ...
        g.Howler = r, g.Howl = l, typeof S != "undefined" ? (S.HowlerGlobal = v, S.Howler = r, S.Howl = l, S.Sound = i) : typeof window != "undefined" && (window.HowlerGlobal = v, window.Howler = r, window.Howl = l, window.Sound = i)
    })();
    /*!
        ...
        HowlerGlobal.prototype._pos = [0, 0, 0], HowlerGlobal.prototype._orientation = [0, 0, -1, 0, 1, 0], HowlerGlobal.prototype.stereo = function(r) {
            ...
            return function(l) {
                ...
                return i._orientation = l.orientation || [1, 0, 0], i._stereo = l.stereo || null, i._pos = l.pos || null, i._pannerAttr = {
                    coneInnerAngle: typeof l.coneInnerAngle != "undefined" ? l.coneInnerAngle : 360,
                    coneOuterAngle: typeof l.coneOuterAngle != "undefined" ? l.coneOuterAngle : 360,
                    coneOuterGain: typeof l.coneOuterGain != "undefined" ? l.coneOuterGain : 0,
                    distanceModel: typeof l.distanceModel != "undefined" ? l.distanceModel : "inverse",
                    maxDistance: typeof l.maxDistance != "undefined" ? l.maxDistance : 1e4,
                    panningModel: typeof l.panningModel != "undefined" ? l.panningModel : "HRTF",
                    refDistance: typeof l.refDistance != "undefined" ? l.refDistance : 1,
                    rolloffFactor: typeof l.rolloffFactor != "undefined" ? l.rolloffFactor : 1
                }, i._onstereo = l.onstereo ? [{
                    fn: l.onstereo
                }] : [], i._onpos = l.onpos ? [{
                    fn: l.onpos
            ...
            if (l = typeof l != "number" ? 0 : l, i = typeof i != "number" ? -.5 : i, typeof c == "undefined")
                if (typeof r == "number") d._pos = [r, l, i];
                else return d._pos;
            for (var y = d._getSoundIds(c), p = 0; p < y.length; p++) {
                var _ = d._soundById(y[p]);
                if (_)
                    if (typeof r == "number") _._pos = [r, l, i], _._node && ((!_._panner || _._panner.pan) && v(_, "spatial"), typeof _._panner.positionX != "undefined" ? (_._panner.positionX.setValueAtTime(r, Howler.ctx.currentTime), _._panner.positionY.setValueAtTime(l, Howler.ctx.currentTime), _._panner.positionZ.setValueAtTime(i, Howler.ctx.currentTime)) : _._panner.setPosition(r, l, i)), d._emit("pos", _._id);
                    else return _._pos
            }
            return d
            ...
            if (l = typeof l != "number" ? d._orientation[1] : l, i = typeof i != "number" ? d._orientation[2] : i, typeof c == "undefined")
                if (typeof r == "number") d._orientation = [r, l, i];
                else return d._orientation;
            for (var y = d._getSoundIds(c), p = 0; p < y.length; p++) {
                var _ = d._soundById(y[p]);
                if (_)
                    if (typeof r == "number") _._orientation = [r, l, i], _._node && (_._panner || (_._pos || (_._pos = d._pos || [0, 0, -.5]), v(_, "spatial")), typeof _._panner.orientationX != "undefined" ? (_._panner.orientationX.setValueAtTime(r, Howler.ctx.currentTime), _._panner.orientationY.setValueAtTime(l, Howler.ctx.currentTime), _._panner.orientationZ.setValueAtTime(i, Howler.ctx.currentTime)) : _._panner.setOrientation(r, l, i)), d._emit("orientation", _._id);
            ...
            if (l.length === 1)
                if (typeof l[0] == "object") i = l[0], typeof c == "undefined" && (i.pannerAttr || (i.pannerAttr = {
                ...
                else return d = r._soundById(parseInt(l[0], 10)), d ? d._pannerAttr : r._pannerAttr;
...
const O = new D({
    ...
    K = {
        ...
        claim: () => {
            if (I.setting.soundEffectEnable) try {
                Q.play()
            } catch (g) {}
        },
        spinStart: () => {
