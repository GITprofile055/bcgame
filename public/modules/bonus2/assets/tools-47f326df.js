...
var _ = l('<div class="flex justify-between text-center">'),
    ...
    S = l('<div class="flex justify-between"><div class="flex flex-col items-center justify-center"><img class="h-12 w-16"></div><div class="ml-4 flex flex-col justify-around"><span class="font-extrabold text-primary"></span><p class="text-sm font-semibold text-secondary">');
const N = 7,
    W = 14,
    H = 21,
    j = 25,
...
export {
    N as C, G as W, q as a, m as b, V as c, P as d, p as e, B as f, M as g, Z as h, H as i, j, W as k, Y as l, L as m, z as n, i as o, X as p
};