...
const T = "/modules/bonus2/assets/avatar-example-8b236820.png";
var W = u('<span class="text-lg font-extrabold text-primary sm:text-xl">'),
    q = u('<h2 class="px-3 py-2">'),
    P = u('<div class="flex flex-col gap-y-4"><div class="flex flex-col gap-y-4 rounded-xl bg-layer4 py-3"><div class="flex flex-col gap-1">'),
    V = u("<div class=pt-2>"),
    h = u("<p>"),
    B = u("<p>:"),
    H = u('<ul class="list-inside list-decimal"><li></li><li></li><li></li><li></li><li></li><li>'),
    F = u('<p class="mt-2 text-primary">:'),
    L = u('<div class="mt-2 rounded-lg bg-layer5 px-2 py-2"><div class="flex items-center gap-x-2 text-primary"><img class=size-10><span></span></div><div class="ml-12 flex flex-col gap-y-2 rounded-md bg-layer3 p-4 text-sm font-semibold text-primary"><p class=""></p><div class=text-brand><div class=item>@Jachk: 888TRX</div><div class=item>@Blrr: 888TRX</div><div class=item>@Pokiuutt: 888TRX</div><div class=item>@Liisdt: 888TRX</div><div class=item>@Yoiohu: 888TRX</div><div class=item>@Loidr: 888TRX</div></div><div>'),
    A = u('<div class="flex flex-col gap-y-3"><p></p><p>'),
    E = u('<div class="flex flex-col gap-y-3"><p></p><p></p><div><p></p><p></p><ul class="list-inside list-decimal"><li></li><li></li></ul></div><p>'),
    U = u("<ul class=popup-rules><li></li><li></li><li></li><li>");
const j = () => {
        const e = k(z),
            {
                isUsHost: i
            } = R.getHostType(y.host),
            n = C(() => (() => {
                var a = W();
        ...
        return (() => {
            ...
            return r(a, o(b, {
                ...
                get children() {
                    return o(I, {
                        get each() {
                            return i ? e().filter(l => l.usHostShow) : e()
                        },
                        children: l => o(v.Item, {
                            get value() {
                                return l.question
    ...
    z = () => [{
        ...
        answer: [(() => {
            ...
            var e = H(),
                ...
                d = s.nextSibling,
                l = d.nextSibling;
            return r(i, () => t("Six players level higher than 4 will be randomly selected and rewarded in chat room every 6 hours.")), r(n, () => t("Bonus will be different according to the currencies.")), r(a, () => t("Players will be randomly selected by Rain algorithm. The players who send more messages have the higher probability to get rewarded.")), r(s, () => t("But even if the user has sent only one message, there is still a chance that they can receive the rain bonus.")), r(d, () => t("Rain information will be sent to the chat room by robots.")), r(l, () => t("Having more than one account per user is prohibited. You will get the lower possibility of receiving rain and BC will suspend your withdrawals for a manual review in the fraud prevention system which may take up to 24 hrs. We do not guarantee withdraw processing and may ban account with your balance in it. If you have already had more than one account please self-surrender by contacting Live Support.")), e
        })(), (() => {
            var e = F(),
                i = e.firstChild;
            ...
            var e = L(),
                ...
                l = d.nextSibling,
                c = l.nextSibling;
            return $(n, "src", T), r(a, () => y.host), r(d, () => t("Raining, the people who received the rain:")), r(c, () => t("Congratulations!")), e
        })()]
    }, {
        ...
        answer: (() => {
            var e = A(),
                i = e.firstChild,
                n = i.nextSibling;
            return r(i, () => t("If you haven’t reached VIP Level 7 and unlocked ‘Coin Drop’, you need to be active and quick in order to grab the coins when it happens in Public Chat. The rewards go to the fastest participants.")), r(n, () => t("Once you have reached VIP Level 7, you may create your own ‘Coin Drop’ and customize the amount and quantity of recipients before you share your good luck and generosity with other players in Public Chat.")), e
        })()
    }, {
        ...
        answer: [(() => {
            var e = h();
            return r(e, () => t("In addition to our existing Weekly Bonus for VIP level 22+ players, we are now introducing the BC Sports Club weekly bonus as an additional perk for sports bettors. The new Sport bonus is specific only to Sport Wager and is calculated based on the player's wagering amount from Saturday to Friday, and distributed automatically every Saturday. With the introduction of the BC Sports Club bonuses, our VIP level 22+ players can now enjoy even more rewards and a thrilling sports betting experience!")), e
        })(), (() => {
            var e = h();
            ...
            var e = U(),
                ...
                a = n.nextSibling,
                s = a.nextSibling;
            return r(i, () => t("Wager $500 or more from Saturday to Friday and receive a $5 Weekend Bonus!")), r(n, () => t("Wager $2,500 or more and receive a $30 Weekend Bonus!")), r(a, () => t("Wager $5,000 or more and receive a $70 Weekend Bonus!")), r(s, () => t("Wager $10,000 or more and receive a $150 Weekend Bonus!")), e
        })(), (() => {
            var e = h();
...
var X = u('<div class="relative mt-10 flex h-56 flex-shrink-0 rounded-xl bg-layer4"><div class="-mt-12 flex w-full flex-col items-center"><div class="relative h-[8.5rem] flex-shrink-0"><img class=h-full alt=img></div><div class="relative text-center"><div class="text-base font-extrabold text-primary sm:text-lg"></div><div class="mt-2 text-xs text-secondary sm:text-base">'),
    D = u('<div class="grid grid-cols-2 gap-x-3 sm:grid-cols-3 sm:gap-y-4">'),
    p = u("<div>");
const m = e => (() => {
        var i = X(),
            n = i.firstChild,
            ...
            l = d.firstChild,
            c = l.nextSibling;
        return r(l, () => e.title), r(c, () => e.desc), S(() => $(s, "src", e.icon)), i
    })(),
    G = () => (() => {
        var e = D();
        return r(e, o(m, {
            ...
            get icon() {
                return g.cardImgWithdraw
            }
        }), null), r(e, o(b, {
            get when() {
                return f.isEnabled(w.LUCKY_SPIN)
            },
            get children() {
                return o(m, {
                    get title() {
            ...
            get icon() {
                return g.cardImgChat
            }
        }), null), r(e, o(b, {
            get when() {
                return f.isEnabled(w.TIPS_RAIN)
            },
            get children() {
                return o(m, {
                    get title() {
