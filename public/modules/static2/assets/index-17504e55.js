var J = (b, i, a) => new Promise((c, r) => {
    var d = u => {
        ...
        s = u => u.done ? c(u.value) : Promise.resolve(u.value).then(d, n);
...
import {
    c as _e
} from "./createHtmlFile-c65d009a.js";
import {
    p as we
} from "./parseHTML-aa0710ee.js";
import {
    c as V
} from "./store-2ed2b91e.js";
import {
    L as Y
} from "./LocalIcon-f88c1ac0.js";
import {
    g as Se,
    a as Ce
} from "./Tool-3513945f.js";
import {
    u as ke
} from "./router-6469ef63.js";
import "./manifest-346499c0.js";
import "./memoize-a925864b.js";
const Me = "/modules/static2/assets/rg-660fbdee.png",
    Re = "/modules/static2/assets/rg_w-b3c75e20.png",
    Pe = "/modules/static2/assets/rg_21-eac4787b.png",
    Be = "/modules/static2/assets/rg_21_w-89dea51e.png";
var De = m('<div class="help-center-box p-4">'),
    Ae = m('<p><img class="mb-2 w-full sm:w-1/2">');
const {
    env: Fe,
    setting: X,
    utils: Ge
    ...
    const {
        ...
        isMxHost: a,
        isUsHost: c
    } = Ge.getHostType(Fe.host), {
        htmlString: r
    } = _e("responsible_gambling"), d = E(() => we(r() || "")), n = i || a;
    return (() => {
        var s = De();
        return e(s, l($, {
            get when() {
            ...
            get children() {
                return l(B, {
                    ...
                    children: (u, o) => u.title ? [P(() => u.title()), l($, {
                        get when() {
                            return o() === 0 && !n
                        },
                        get children() {
                            var f = Ae(),
                                p = f.firstChild;
                            return R(() => M(p, "src", c ? X.darken ? Pe : Be : X.darken ? Me : Re)), f
                        }
...
const {
    cx: Oe
} = globalThis._bc.fcsy, Te = function(i) {
    const {
        htmlString: a
    } = _e(i.name), c = E(() => we(a() || ""));
    return (() => {
        ...
        return e(r, l($, {
            ...
            get children() {
                return [l(B, {
                    ...
                    children: d => d.title ? [P(() => d.title()), P(() => d.content())] : d.content()
                }), P(() => i.children)]
            }
        })), R(() => ve(r, Oe("help-center-box", i.class))), r
    })()
};
var Le = m("<span>"),
...
const {
    ...
    return (() => {
        ...
        return e(o, l($, {
            ...
            name: "Cooldown1",
            get class() {
                return Z("size-8", r.transStatus > 0 ? "text-brand" : "text-secondary")
            },
            viewBox: "0 0 32 32"
            ...
            return y !== g.e && ((g.e = y) != null ? p.style.setProperty("background-color", y) : p.style.removeProperty("background-color")), x !== g.t && ((g.t = x) != null ? _.style.setProperty("background-color", x) : _.style.removeProperty("background-color")), g
        }, {
            e: void 0,
            t: void 0
        }), o
        ...
        return e(r, l($, {
            ...
            children: d => [l($, {
                ...
                get children() {
                    var n = Qe(),
                        s = n.firstChild;
                    return e(n, () => d().days, s), n
                }
            }), (() => {
                var n = We(),
                    s = n.firstChild;
                return e(n, () => c(d().hours), s), n
            })(), (() => {
                var n = Je(),
                    s = n.firstChild;
                return e(n, () => c(d().minutes), s), n
            })(), (() => {
                var n = Xe(),
                    s = n.firstChild;
                return e(n, () => c(d().seconds), s), n
            })()]
        })), r
    })()
}, ut = {
...
const bt = function() {
    return (() => {
        var i = gt(),
            ...
            L = _.nextSibling,
            C = s.nextSibling;
        return e(a, () => t("Self-Assessment")), e(r, l(ye, {
...
var ft = m('<p class="font-extrabold text-secondary">'),
    ...
    ee = m('<div class="mt-3 flex h-5 w-full items-center justify-between font-semibold text-secondary"><span></span><span>'),
    te = m('<img class="-order-1 w-6">');
const {
    account: j,
    bc: U,
    Decimal: le,
    ...
    const [i, a] = V({
        ...
        loans: 0,
        other: 0
    }), d = E(() => i.benefits + i.other + i.pensions + i.wages), n = E(() => [{
        ...
        onChange: o => {},
        isTotal: !0
    }]), s = E(() => c.loans + c.other + c.rent + c.utility), u = E(() => [{
    ...
    return (() => {
        ...
        return e(o, l($, {
            ...
            get children() {
                var h = ft();
                return e(h, () => t("Buget Calculator")), h
            }
        }), f), e(T, () => t("Income")), e(p, l(B, {
            get each() {
                return n()
            },
            children: h => [(() => {
                var g = ee(),
                    y = g.firstChild,
                    x = y.nextSibling;
                return e(y, () => h.label()), e(x, () => se.printCurrency(new le(h.value))), g
            })(), l(ne, {
                get value() {
                    return h.value
                },
                ...
                get children() {
                    var g = te();
                    return R(() => M(g, "src", U.coinIcon(j.setting.localeCurrencyName))), g
                }
            })]
        ...
        }), null), e(L, () => t("Disposable income")), e(H, () => d() - s()), R(() => M(I, "src", U.coinIcon(j.setting.localeCurrencyName))), o
    })()
};
...
function Ie(b) {
    const [i, a] = F(!1), [c, r] = F(!1), d = n => J(this, null, function*() {
        if (!i()) try {
    ...
    return l($, {
        ...
        get children() {
            return l($, {
                ...
                get children() {
                    var n = xt();
                    return n.$$click = () => d(b.cat), e(n, () => t("Remove")), n
                }
            })
        }
    })
    ...
    return l($, {
        ...
        get children() {
            var a = kt(),
                ...
                S = f.nextSibling,
                k = c.nextSibling;
            return e(d, () => t("Type")), e(n, () => t("Limit")), e(o, () => t("Reset Period")), e(u, l(ce, {
                get title() {
                ...
                children: (v, _) => {
                    ...
                    return (() => {
                        var I = Tt(),
                            ...
                            O = D.nextSibling,
                            w = z.nextSibling;
                        return e(H, () => Se(v.limitType)), e(y, () => oe.toFiatStr(new re(C), v.currencyName)), e(G, () => Ce(v.startTime, v.limitPeriod)), e(D, () => oe.toFiatStr(new re(Math.max(C - L, 0)), v.currencyName)), e(O, () => t("Left")), e(w, l(Ie, {
                            cat: v
                        })), R(N => {
                            var A = _() > 0 ? "h-14 border-b border-solid border-third" : "h-14",
                                Q = ie.coinIcon(v.currencyName),
                                W = ie.coinIcon(v.currencyName);
                            return A !== N.e && ve(I, N.e = A), Q !== N.t && M(g, "src", N.t = Q), W !== N.a && M(q, "src", N.a = W), N
                        }, {
                            e: void 0,
                            t: void 0,
                            a: void 0
                ...
                children: a => {
                    ...
                    return (() => {
                        var d = It(),
                            ...
                            D = q.firstChild,
                            O = D.nextSibling;
                        return e(u, () => t("Type")), e(o, () => Se(a.limitType)), e(T, () => t("Reset Period")), e(p, l(fe, {
                            get title() {
                                return (() => {
                                    var w = ue();
                        ...
                        }), null), e(S, () => Ce(a.startTime, a.limitPeriod)), e(_, () => t("Limit")), e(I, () => be.toFiatStr(new me(r), a.currencyName)), e(g, () => t("Progress")), e(h, l(fe, {
                            get title() {
                                return (() => {
                                    var w = ue();
                        ...
                        }), null), e(G, () => be.toFiatStr(new me(Math.max(r - c, 0)), a.currencyName)), e(z, () => t("Left")), e(D, () => t("Action")), e(O, l(Ie, {
                            cat: a
                        })), R(w => {
                            var N = de.coinIcon(a.currencyName),
                                A = de.coinIcon(a.currencyName);
                            return N !== w.e && M(C, "src", w.e = N), A !== w.t && M(x, "src", w.t = A), w
                        }, {
                            e: void 0,
                            t: void 0
                        }), d
...
const {
    ...
    const n = () => {
        Pt().get("/user/gambling/limit/list/").then(s => {
            s && He(() => {
                d(s.settingList || []), c(s.selfExclusion)
            })
        }).catch(Bt)
    };
    return Ht.on("update-gambling-limit-list", () => {
        he.login && n()
    }), (() => {
        var s = Et(),
            u = s.firstChild,
            ...
            f = o.nextSibling,
            p = f.nextSibling;
        return e(u, () => t("Gambling Limits")), e(s, l($, {
            get when() {
                return Rt.mobile
            },
            get fallback() {
        ...
        }), o), e(o, () => t("Gain control over your play or betting by using loss or wagering limits. These limits allow you to control the maximum loss or wagered amount over a daily, weekly or monthly period.")), e(f, () => t("Your limit will apply immediately and will reset when that time is reached. E.g. If you set a $100 daily loss limit at 2pm today, the limit will reset at 0:00 (UTC+0) tomorrow.")), e(p, () => t("The changes to remove your limits will updated at 0:00(UTC+0) of the next day.")), e(s, l(Mt, {
            class: "mt-3 w-full",
            type: "brand",
...
}, Ft = "/modules/static2/assets/support-07844a6f.png";
var Gt = m('<div class="center flex w-full flex-col rounded-lg bg-layer4 px-4 pb-6 xl:w-[230px] xl:flex-none"><img alt=users class="mt-6 size-20"><div class="mt-4 text-base text-primary"></div><div class="mt-4 text-center text-secondary"></div><div class="text-center text-secondary">');
const {
    app: zt,
    Button: qt
    ...
    return (() => {
        var i = Gt(),
            ...
            r = c.nextSibling,
            d = r.nextSibling;
        return M(a, "src", Ft), e(c, () => t("Need Help?")), e(r, () => t("Have questions or concerns regarding your account?")), e(d, () => t("Our experts are here to help!")), e(i, l(qt, {
            type: "brand",
            class: "mt-4 w-full",
            onClick: () => zt.emit("live_support", !0),
            get children() {
...
const {
    ...
    K(() => {
        Object.keys(i.routesMap).find(u => u === a.responsibleId) || c("/responsible/faq")
    });
    const d = () => {
            const s = Object.keys(i.routesMap).find(u => u === a.responsibleId);
            return {
                key: s || "faq",
                value: s ? i.routesMap[s] : i.routesMap.faq
            }
        },
        n = E(() => Qt.includes(d().key));
    return l(Vt, {
        get title() {
            ...
            return [(() => {
                ...
                return e(s, l(Yt, {
                    ...
                    children: u => (() => {
                        ...
                        return e(o, () => {
                            var f;
                            return (f = i.routesMap[u()]) == null ? void 0 : f.label()
                        }), o
                    })()
                })), s
            })(), (() => {
    ...
    const r = E(() => Object.keys(i.routesMap).map(n => ({
            ...
            title: (() => {
                ...
                return e(s, l(Y, {
                    ...
                    class: "size-5"
                }), u), e(u, () => i.routesMap[n].label()), s
            })()
        }))),
        d = E(() => sl.includes(c.responsibleId));
    return l(ll, {
        get title() {
            return (() => {
                var n = Zt();
                ...
                get children() {
                    return l($, {
                        ...
                        get children() {
                            ...
                            return e(s, () => {
                                var u;
                                return (u = i.routesMap[c.responsibleId]) == null ? void 0 : u.element()
                            }), e(n, l($, {
                                get when() {
                                    return d()
                                },
...
function pe() {
    return {
        ...
        "buget-calculator": {
            label: () => t("Buget Calculator"),
            link: "/responsible/buget-calculator",
