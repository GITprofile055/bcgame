const e = "Actions",
    ...
    St = "wallet",
    Ot = "Wallet",
    Dt = `<0>{GUIDE.title}</0><1>{GUIDE.subtitle}</1><2>{GUIDE.introduction}</2><3>{(step) => (
              <div class="mt-5">
                <div class="font-medium">{step.title}</div>
                <Show when={step.subtitle}>
                  <div class="text-secondary mt-1">{step.subtitle}</div>
                </Show>
                <For each={step.items}>{(item) => <div class="text-secondary mt-1">• {item}</div>}</For>
              </div>
            )}</3><4>{GUIDE.conclusion}</4>`,
    Nt = "Whitepaper",
    At = "Withdraw",
    It = "Yesterday",
    Bt = {
        ...
        "No Arrival in 7 Days? Full ManualCredit!": "No Arrival in 7 Days? Full ManualCredit!",
        ...
        "Please enter the correct withdrawal amount.": "Please enter the correct withdrawal amount.",
        ...
        "Please fill in the correct withdrawal address": "Please fill in the correct withdrawal address",
        ...
        "wallet.trans.desc47": "Withdrawals can only be made to either the <2>Cwallet</2>or a decentralized wallet to prevent potential asset loss.",
        ...
        "Withdrawal amount should be greater than the fee": "Withdrawal amount should be greater than the fee",
        ...
        "You must read and consent to this agreement": "You must read and consent to this agreement",
        ...
        "Your deposit amount and deposit bonus will be credited in your casino bonus balance.": "Your deposit amount and deposit bonus will be credited in your casino bonus balance.",
        "Your deposit amount and deposit bonus will be credited in your sports bonus balance.": "Your deposit amount and deposit bonus will be credited in your sports bonus balance.",
        "Your deposit bonus will be credited in your locked rackback bonus balance.": "Your deposit bonus will be credited in your locked rackback bonus balance.",
...
export {
    i as APR, e as Actions, t as Add, a as Address, o as Affiliate, n as All, r as Amount, s as Assets, l as Auto, d as Available, u as Balance, c as BetHistory, h as Bets, p as Bill, m as Bonus, y as Bought, f as Burnt, _ as Buy, w as Cancel, b as Canceled, g as Cash, C as Channel, T as Circulating, v as Code, k as Complete, P as Confirm, S as Continue, O as Contract, D as Copied, N as Credited, I as Crypto, B as Cryptocurrency, E as Custom, R as Deposit, W as Depositor, F as Details, H as Disclaimer, Y as Done, U as Download, M as Ended, x as Evidence, q as Example, L as Exclusive, G as Expired, K as Extra, X as FIAT, z as Failed, j as Fee, Q as Fees, J as Fiat, Z as From, ee as Game, te as History, ae as Hold, oe as Holders, ne as Horse, re as INIT, ie as Interests, se as Live, le as Locked, de as Lottery, ue as Manage, ce as Matches, he as Max, pe as Memo, me as Merchant, ye as Message, fe as Min, _e as More, we as Multiplier, be as Network, Ce as Numbers, Te as OK, ve as Ongoing, ke as Online, Pe as Only, Oe as Optional, De as OrderId, Ne as Original, Ae as Overview, Ie as Payout, Be as Paywith, Ee as Pending, Ve as Player, Re as Preview, We as Price, Fe as Processing, He as Profit, Ye as Progress, Ue as Rate, Me as Recommend, xe as Recommended, qe as Refunded, Le as Register, Ge as Registering, Ke as Reload, ze as Required, je as Rollover, Qe as Save, $e as Search, Je as Seconds, Xe as Sell, Ze as Slots, et as Sports, tt as Status, at as Submit, ot as Success, nt as Successful, rt as Supply, it as Swap, lt as Time, dt as To, ut as Trade, ct as Trader, ht as Trading, pt as Transaction, mt as Transactions, yt as Txid, ft as Type, _t as Understood, wt as Upcoming, bt as Upload, gt as Uploading, Ct as User, Tt as Value, vt as Vault, kt as Verify, Pt as Wager, Ot as Wallet, Nt as Whitepaper, At as Withdraw, It as Yesterday, A as crypto, V as date, Bt as
    default, $ as fiat, ge as note, Se as opt, st as tickets, St as wallet, Dt as wallet_conver_text_infos
};