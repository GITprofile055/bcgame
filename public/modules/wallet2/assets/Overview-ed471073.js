...
var ki = (i, t, e) => t in i ? ir(i, t, {
    ...
    Ie = (i, t) => {
        for (var e in t || (t = {})) or.call(t, e) && ki(i, e, t[e]);
        if (ws)
            for (var e of ws(t)) rr.call(t, e) && ki(i, e, t[e]);
        return i
    },
    Fe = (i, t) => sr(i, nr(t));
var w = (i, t, e) => (ki(i, typeof t != "symbol" ? t + "" : t, e), e);
var ze = (i, t, e) => new Promise((s, n) => {
    var o = l => {
            try {
                a(e.next(l))
            } catch (c) {
...
import "./data-aad419fc.js";
var Tr = it('<div class="rounded-lg text-sm font-semibold inline-block py-0.5 uppercase">'),
    Lr = it('<div class="flex items-center gap-1 overflow-hidden justify-center">'),
    Rr = it('<div class="flex justify-center gap-2"><span class=text-secondary></span><img class="w-5 object-contain"alt="coin logo">'),
    Er = it('<div class="flex justify-center"><span class=text-secondary>'),
    Ir = it('<div class="flex gap-2 justify-end"><span></span><img class="w-5 object-contain"alt="coin logo">'),
    Ss = it("<div class=text-sm>"),
    Fr = it("<div>");
...
function to(i) {
    return [{
        ...
        render(t) {
            return (() => {
                var e = Tr();
                return P(e, () => t.gameName), e
            })()
        }
    }, ...i ? [{
        title: B("Player"),
        dataIndex: "Player",
        width: Ut.mobile ? 113 : 244,
        align: "center",
        render(t) {
            return (() => {
                var e = Lr();
                return P(e, I(pr, {
                    get href() {
                        return `/user/profile/${t.userId}`
                    },
                    class: "block text-primary truncate hover:underline",
                    get children() {
                        return t.nickName
                    }
                })), e
        ...
        render(t) {
            return (() => {
                var e = Rr(),
                    s = e.firstChild,
                    n = s.nextSibling;
                return P(s, () => Number(t.betAmount).toFixed(2)), Ni(() => Ht(n, "src", Ms.darken ? Be.assets("/logo/logo_small.png") : Be.assets("/logo/logo_small_w.png"))), e
            })()
        }
    }], {
        title: B("Multiplier"),
        dataIndex: "oddsString",
        align: "center",
        width: 80,
        render(t) {
            return (() => {
                var e = Er(),
                    s = e.firstChild;
                return P(s, () => `${Number(t.oddsString).toFixed(2)}x`), e
            })()
        }
    }, {
        title: B("Profit"),
        ...
        align: "right",
        render(t) {
            let e = t.winAmount - t.betAmount;
            return (() => {
                var s = Ir(),
                    n = s.firstChild,
                    o = n.nextSibling;
                return P(n, () => e > 0 ? `+${e.toFixed(2)}` : e.toFixed(2)), Ni(r => {
                    var a = mr(e > 0 ? "text-brand" : "text-secondary"),
                        l = Ms.darken ? Be.assets("/logo/logo_small.png") : Be.assets("/logo/logo_small_w.png");
                    return a !== r.e && qn(n, r.e = a), l !== r.t && Ht(o, "src", r.t = l), r
                }, {
                    e: void 0,
                    t: void 0
                }), s
...
function zr() {
    ...
    return I(Zn, {
        ...
        onRowClick: e => {
            t(`/game-detail/${e.distributeId}`)
        }
    })
}

function Br() {
    const [i] = li(is(), Mr), t = Gn();
    return I(Zn, {
        get columns() {
            return to(!0)
        },
        get dataSource() {
            return Qn.bets.public
        },
        get loading() {
            return i.loading
        },
...
function Nr(i) {
    ...
    const t = hr(() => I(Mi, {
        type: "inner",
        get class() {
            return Ut.mobile ? "light-layer3-tabs" : "light-layer2-tabs w-52"
        },
        get children() {
            return [I(dr, {
                get when() {
...
const at = {
    ...
    Wi = [..."0123456789ABCDEF"],
    Wr = i => Wi[i & 15],
    Vr = i => Wi[(i & 240) >> 4] + Wi[i & 15],
    Ne = i => (i & 240) >> 4 === (i & 15),
    $r = i => Ne(i.r) && Ne(i.g) && Ne(i.b) && Ne(i.a);
...
const jr = (i, t) => i < 255 ? t(i) : "";

function Yr(i) {
    var t = $r(i) ? Wr : Vr;
    return i ? "#" + t(i.r) + t(i.g) + t(i.b) + jr(i.a, t) : void 0
}
...
function ss(i) {
    const e = i.r / 255,
        ...
        a = (o + r) / 2;
    let l, c, h;
    return o !== r && (h = o - r, c = a > .5 ? h / (2 - o - r) : h / (o + r), l = qr(e, s, n, h, o), l = l * 60 + .5), [l | 0, c || 0, a]
}
...
function Zr(i) {
    ...
    let e = 255,
        s;
    if (!t) return;
    t[5] !== s && (e = t[6] ? ue(+t[5]) : Lt(+t[5]));
    const n = io(+t[2]),
        o = +t[3] / 100,
        r = +t[4] / 100;
    return t[1] === "hwb" ? s = Gr(n, o, r) : t[1] === "hsv" ? s = Jr(n, o, r) : s = os(n, o, r), {
        r: s[0],
        g: s[1],
        b: s[2],
        a: e
...
function Qr(i, t) {
    var e = ss(i);
    e[0] = io(e[0] + t), e = os(e), i.r = e[0], i.g = e[1], i.b = e[2]
}
...
function ta(i) {
    ...
    const t = ss(i),
        ...
        s = Cs(t[1]),
        n = Cs(t[2]);
    return i.a < 255 ? `hsla(${e}, ${s}%, ${n}%, ${vt(i.a)})` : `hsl(${e}, ${s}%, ${n}%)`
}
const Ps = {
        x: "dark",
        Z: "light",
...
function ea() {
    ...
    for (s = 0; s < t.length; s++) {
        for (r = a = t[s], n = 0; n < e.length; n++) o = e[n], a = a.replace(o, Ps[o]);
        o = parseInt(Ds[r], 16), i[a] = [o >> 16 & 255, o >> 8 & 255, o & 255]
    }
    return i
}
let We;
...
function ia(i) {
    We || (We = ea(), We.transparent = [0, 0, 0, 0]);
...
const sa = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/;
...
function na(i) {
    ...
    if (t) {
        if (t[7] !== s) {
            const r = +t[7];
            e = t[8] ? ue(r) : Dt(r * 255, 0, 255)
        }
        return s = +t[1], n = +t[3], o = +t[5], s = 255 & (t[2] ? ue(s) : Dt(s, 0, 255)), n = 255 & (t[4] ? ue(n) : Dt(n, 0, 255)), o = 255 & (t[6] ? ue(o) : Dt(o, 0, 255)), {
            r: s,
            g: n,
            b: o,
            a: e
...
const Si = i => i <= .0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - .055,
    te = i => i <= .04045 ? i / 12.92 : Math.pow((i + .055) / 1.055, 2.4);
...
function ra(i, t, e) {
    const s = te(vt(i.r)),
        ...
        o = te(vt(i.b));
    return {
        r: Lt(Si(s + e * (te(vt(t.r)) - s))),
        g: Lt(Si(n + e * (te(vt(t.g)) - n))),
        b: Lt(Si(o + e * (te(vt(t.b)) - o))),
        a: i.a + e * (t.a - i.a)
    }
}
...
function Ve(i, t, e) {
    if (i) {
        let s = ss(i);
        s[t] = Math.max(0, Math.min(s[t] + s[t] * e, t === 0 ? 360 : 1)), s = os(s), i.r = s[0], i.g = s[1], i.b = s[2]
    }
}
...
class ke {
    constructor(t) {
        ...
        const e = typeof t;
        let s;
        e === "object" ? s = Os(t) : e === "string" && (s = Hr(t) || ia(t) || aa(t)), this._rgb = s, this._valid = !!s
    }
    get valid() {
        return this._valid
    }
...
const ca = (i, t) => typeof i == "string" && i.endsWith("%") ? parseFloat(i) / 100 : +i / t,
    no = (i, t) => typeof i == "string" && i.endsWith("%") ? parseFloat(i) / 100 * t : +i;
...
function hi(i) {
    if (V(i)) return i.map(hi);
    if (L(i)) {
        const t = Object.create(null),
            e = Object.keys(i),
            s = e.length;
        let n = 0;
        for (; n < s; ++n) t[e[n]] = hi(i[e[n]]);
        return t
    }
    return i
}
...
function da(i, t, e) {
    ...
    const s = t[i],
        n = e[i];
    L(s) && L(n) ? xe(s, n) : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = hi(n))
}
const As = {
    "": i => i,
    x: i => i.x,
...
function Rt(i, t) {
    return (As[t] || (As[t] = fa(t)))(i)
}

function rs(i) {
    return i.charAt(0).toUpperCase() + i.slice(1)
}
const Se = i => typeof i != "undefined",
    Et = i => typeof i == "function",
    Ts = (i, t) => {
...
const Mt = (i, t, e, s) => ls(i, e, s ? n => {
        const o = i[n][t];
        return o < e || o === e && i[n + 1][t] === e
    } : n => i[n][t] < e),
    va = (i, t, e) => ls(i, e, s => i[s][t] >= e);
...
function Is(i, t) {
    ...
    const s = e.listeners,
        n = s.indexOf(t);
    n !== -1 && s.splice(n, 1), !(s.length > 0) && (lo.forEach(o => {
        delete i[o]
    }), delete i._chartjs)
}
...
const cs = i => i === "start" ? "left" : i === "end" ? "right" : "center",
    J = (i, t, e) => i === "start" ? t : i === "end" ? e : (t + e) / 2,
    Sa = (i, t, e, s) => i === (s ? "left" : "right") ? e : i === "center" ? (t + e) / 2 : t;
...
function fo(i, t, e) {
    ...
    if (i._sorted) {
        ...
        d && (n = G(Math.min(Mt(a, l, c).lo, e ? s : Mt(t, l, r.getPixelForValue(c)).lo), 0, s - 1)), u ? o = G(Math.max(Mt(a, r.axis, h, !0).hi + 1, e ? 0 : Mt(t, l, r.getPixelForValue(h), !0).hi + 1), n, s) - n : o = s - n
    }
    return {
        start: n,
        count: o
...
const $e = i => i === 0 || i === 1,
    Fs = (i, t, e) => -(Math.pow(2, 10 * (i -= 1)) * Math.sin((i - t) * $ / e)),
    zs = (i, t, e) => Math.pow(2, -10 * i) * Math.sin((i - t) * $ / e) + 1,
    ye = {
        linear: i => i,
        easeInQuad: i => i * i,
        easeOutQuad: i => -i * (i - 2),
        ...
        easeInOutExpo: i => $e(i) ? i : i < .5 ? .5 * Math.pow(2, 10 * (i * 2 - 1)) : .5 * (-Math.pow(2, -10 * (i * 2 - 1)) + 2),
        easeInCirc: i => i >= 1 ? i : -(Math.sqrt(1 - i * i) - 1),
        easeOutCirc: i => Math.sqrt(1 - (i -= 1) * i),
        easeInOutCirc: i => (i /= .5) < 1 ? -.5 * (Math.sqrt(1 - i * i) - 1) : .5 * (Math.sqrt(1 - (i -= 2) * i) + 1),
        easeInElastic: i => $e(i) ? i : Fs(i, .075, .3),
        easeOutElastic: i => $e(i) ? i : zs(i, .075, .3),
        easeInOutElastic(i) {
            return $e(i) ? i : i < .5 ? .5 * Fs(i * 2, .1125, .45) : .5 + .5 * zs(i * 2 - 1, .1125, .45)
        },
        easeInBack(i) {
        ...
        easeInBounce: i => 1 - ye.easeOutBounce(1 - i),
        easeOutBounce(i) {
        ...
        easeInOutBounce: i => i < .5 ? ye.easeInBounce(i * 2) * .5 : ye.easeOutBounce(i * 2 - 1) * .5 + .5
    };
...
function Bs(i) {
    return hs(i) ? i : new ke(i)
}

function Ci(i) {
    return hs(i) ? i : new ke(i).saturate(.5).darken(.1).hexString()
}
const Ca = ["x", "y", "borderWidth", "radius", "tension"],
    Pa = ["color", "borderColor", "backgroundColor"];
...
const po = {
    ...
    numeric(i, t, e) {
        ...
        if (e.length > 1) {
            ...
            (c < 1e-4 || c > 1e15) && (n = "scientific"), o = Ta(i, e)
        }
    ...
    logarithmic(i, t, e) {
        if (i === 0) return "0";
        const s = e[t].significand || i / Math.pow(10, Math.floor(Ot(i)));
        return [1, 2, 3, 5, 10, 15].includes(s) || t > .8 * e.length ? po.numeric.call(this, i, t, e) : ""
    }
};
...
function Pi(i, t, e) {
    return typeof t == "string" ? Me(ve(i, t), e) : Me(ve(i, ""), t)
}
class Ra {
    constructor(t, e) {
...
function Ia(i, t, e, s) {
    ...
    let l, c, h, d, u;
    for (l = 0; l < a; l++)
        if (d = e[l], d != null && !V(d)) r = ui(i, n, o, r, d);
        else if (V(d))
        for (c = 0, h = d.length; c < h; c++) u = d[c], u != null && !V(u) && (r = ui(i, n, o, r, u));
    i.restore();
    const f = o.length / 2;
    if (f > e.length) {
...
function mo(i, t, e, s, n) {
    ...
    if (!(isNaN(p) || p <= 0)) {
        switch (i.beginPath(), f) {
            default: n ? i.ellipse(e, s, n / 2, p, 0, 0, $) : i.arc(e, s, p, 0, $),
            i.closePath();
            break;
            case "triangle":
                    h = n ? n / 2 : p,
            ...
            case "rectRounded":
                ...
                l = p - c,
                r = Math.cos(m + zt) * l,
                d = Math.cos(m + zt) * (n ? n / 2 - c : l),
                a = Math.sin(m + zt) * l,
                u = Math.sin(m + zt) * (n ? n / 2 - c : l),
                i.arc(e - d, s - a, c, m - H, m - X),
                i.arc(e + u, s - r, c, m - X, m),
                i.arc(e + d, s + a, c, m, m + X),
                i.arc(e - u, s + r, c, m + X, m + H),
                i.closePath();
                break;
            case "rect":
                    if (!g) {
...
function Gt(i, t, e, s, n, o = {}) {
    ...
    let l, c;
    for (i.save(), i.font = n.string, Ba(i, o), l = 0; l < r.length; ++l) c = r[l], o.backdrop && Wa(i, o.backdrop), a && (o.strokeColor && (i.strokeStyle = o.strokeColor), E(o.strokeWidth) || (i.lineWidth = o.strokeWidth), i.strokeText(c, e, s, o.maxWidth)), i.fillText(c, e, s, o.maxWidth), Na(i, e, s, c, o), s += Number(n.lineHeight);
    i.restore()
}
...
function Pe(i, t) {
    ...
    i.arc(e + r.topLeft, s + r.topLeft, r.topLeft, 1.5 * H, H, !0), i.lineTo(e, s + o - r.bottomLeft), i.arc(e + r.bottomLeft, s + o - r.bottomLeft, r.bottomLeft, H, X, !0), i.lineTo(e + n - r.bottomRight, s + o), i.arc(e + n - r.bottomRight, s + o - r.bottomRight, r.bottomRight, X, 0, !0), i.lineTo(e + n, s + r.topRight), i.arc(e + n - r.topRight, s + r.topRight, r.topRight, 0, -X, !0), i.lineTo(e + r.topLeft, s)
}
const Va = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
    $a = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
...
function ds(i, t) {
    const e = {},
        s = L(t),
        n = s ? Object.keys(t) : t,
        o = L(i) ? s ? r => A(i[r], i[t[r]]) : r => i[r] : () => i;
    for (const r of n) e[r] = ja(o(r));
    return e
}
...
function q(i, t) {
    ...
    s && !("" + s).match($a) && (console.warn('Invalid font style specified: "' + s + '"'), s = void 0);
    const n = {
        family: A(i.family, t.family),
        lineHeight: Ha(A(i.lineHeight, t.lineHeight), e),
        size: e,
        style: s,
        weight: A(i.weight, t.weight),
        string: ""
    };
    return n.string = Ea(n), n
}
...
function fe(i, t, e, s) {
    ...
    for (o = 0, r = i.length; o < r; ++o)
        if (a = i[o], a !== void 0 && (t !== void 0 && typeof a == "function" && (a = a(t), n = !1), e !== void 0 && V(a) && (a = a[e % a.length], n = !1), a !== void 0)) return s && !n && (s.cacheable = !1), a
}
...
function Ya(i, t, e) {
    const {
        min: s,
        max: n
    } = i, o = no(t, (n - s) / 2), r = (a, l) => e && a === 0 ? 0 : a + l;
    return {
        min: r(s, -Math.abs(o)),
        max: r(n, o)
    }
...
function us(i, t = [""], e, s, n = () => i[0]) {
    const o = e || i;
    typeof s == "undefined" && (s = vo("_fallback", i));
    const r = {
...
function ne(i, t, e, s) {
    const n = {
        ...
        _stack: new Set,
        _descriptors: xo(i, s),
        setContext: o => ne(i, o, e, s),
        override: o => ne(i.override(o), t, e, s)
    };
    return new Proxy(n, {
        deleteProperty(o, r) {
...
const Ua = (i, t) => i ? i + rs(t) : t,
    fs = (i, t) => L(t) && i !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
...
function Xa(i, t, e) {
    ...
    let a = s[t];
    return Et(a) && r.isScriptable(t) && (a = Ka(t, a, i, e)), V(a) && a.length && (a = qa(t, a, i, r.isIndexable)), fs(t, a) && (a = ne(a, n, o && o[t], r)), a
}
...
function Ka(i, t, e, s) {
    ...
    a.add(i);
    let l = t(o, r || s);
    return a.delete(i), fs(i, l) && (l = gs(n._scopes, n, i, l)), l
}
...
const Ga = (i, t) => i === !0 ? t : typeof i == "string" ? Rt(t, i) : void 0;
...
function gs(i, t, e, s) {
    const n = t._rootScopes,
        o = yo(t._fallback, e, s),
        r = [...i, ...n],
        a = new Set;
    a.add(s);
    let l = Vs(a, r, e, o || e, s);
    return l === null || typeof o != "undefined" && o !== e && (l = Vs(a, r, o, l, s), l === null) ? !1 : us(Array.from(a), [""], n, o, () => Za(t, e, s))
}
...
function Qa(i, t, e, s) {
    let n;
    for (const o of t)
        if (n = vo(Ua(o, i), e), typeof n != "undefined") return fs(i, n) ? gs(e, s, i, n) : n
}
...
function $s(i) {
    let t = i._keys;
    return t || (t = i._keys = tl(i._scopes)), t
}
...
function nl(i, t, e = "x") {
    ...
    let o, r, a, l = oe(i, 0);
    for (let c = 0; c < n; ++c) {
        if (r = a, a = l, l = oe(i, c + 1), !a) continue;
        const h = a[e],
            d = a[s];
...
function ol(i, t = "x") {
    ...
    for (r = 0; r < s; ++r)
        if (a = l, l = c, c = oe(i, r + 1), !!l) {
            ...
            o[r] = a ? c ? mt(n[r - 1]) !== mt(n[r]) ? 0 : (n[r - 1] + n[r]) / 2 : n[r - 1] : n[r]
        }
    sl(i, n, o), nl(i, o, t)
}
...
function rl(i, t) {
    ...
    for (e = 0, s = i.length; e < s; ++e) r = o, o = a, a = e < s - 1 && St(i[e + 1], t), o && (n = i[e], r && (n.cp1x = He(n.cp1x, t.left, t.right), n.cp1y = He(n.cp1y, t.top, t.bottom)), a && (n.cp2x = He(n.cp2x, t.left, t.right), n.cp2y = He(n.cp2y, t.top, t.bottom)))
}

function al(i, t, e, s, n) {
    let o, r, a, l;
    if (t.spanGaps && (i = i.filter(c => !c.skip)), t.cubicInterpolationMode === "monotone") ol(i, n);
    else {
        let c = s ? i[i.length - 1] : i[0];
        for (o = 0, r = i.length; o < r; ++o) a = i[o], l = il(c, a, i[Math.min(o + 1, r - (s ? 0 : 1)) % r], t.tension), a.cp1x = l.previous.x, a.cp1y = l.previous.y, a.cp2x = l.next.x, a.cp2y = l.next.y, c = a
    }
    t.capBezierPoints && rl(i, e)
}
...
const cl = ["top", "right", "bottom", "left"];
...
function Vt(i, t) {
    ...
    } = t, n = vi(e), o = n.boxSizing === "border-box", r = Kt(n, "padding"), a = Kt(n, "border", "width"), {
        x: l,
        y: c,
        box: h
    } = dl(i, e), d = r.left + (h && a.left), u = r.top + (h && a.top);
    let {
        width: f,
        height: g
    } = t;
...
function fl(i, t, e, s) {
    const n = vi(i),
        o = Kt(n, "margin"),
        r = fi(n.maxWidth, i, "clientWidth") || di,
        a = fi(n.maxHeight, i, "clientHeight") || di,
        l = ul(i, t, e);
    let {
        width: c,
        height: h
    ...
    if (n.boxSizing === "content-box") {
        const u = Kt(n, "border", "width"),
            f = Kt(n, "padding");
        c -= f.width + u.width, h -= f.height + u.height
    }
    return c = Math.max(0, c - o.width), h = Math.max(0, s ? c / s : h - o.height), c = je(Math.min(c, r, l.maxWidth)), h = je(Math.min(h, a, l.maxHeight)), c && !h && (h = je(c / 2)), (t !== void 0 || e !== void 0) && s && l.height && h > l.height && (h = l.height, c = je(Math.floor(h * s))), {
        width: c,
        height: h
    }
}
...
function Po(i, t, e) {
    ...
    const v = () => l(n, y, b) && a(n, y) !== 0,
        ...
        M = () => p || v(),
        k = () => !p || _();
    for (let S = h, C = h; S <= d; ++S) x = t[S % r], !x.skip && (b = c(x[s]), b !== y && (p = l(b, n, o), m === null && M() && (m = a(b, n) === 0 ? S : C), m !== null && k() && (g.push(Ys({
        start: m,
        end: S,
        loop: u,
        count: r,
...
function wl(i, t) {
    ...
    return Us(i, vl(e, r, l, c), e, t)
}

function Us(i, t, e, s) {
    return !s || !s.setContext || !e ? t : kl(i, t, e, s)
}
    ...
    for (const g of t) {
        ...
        for (u = d + 1; u <= g.end; u++) {
            ...
            m = Xs(s.setContext(It(n, {
                ...
                p1DataIndex: u % l,
                datasetIndex: r
            }))), Ml(m, h) && f(d, u - 1, g.loop, h), p = b, h = m
        }
...
class Pl {
    constructor(t, e, s, n) {
        ...
        const r = fe([t.from, o, n]);
        this._active = !0, this._fn = t.fn || Cl[t.type || typeof r], this._easing = ye[t.easing] || ye.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = s, this._from = r, this._to = n, this._promises = void 0
    }
    active() {
        return this._active
    }
    update(t, e, s) {
        if (this._active) {
            ...
            const n = this._target[this._prop],
                o = s - this._start,
                r = this._duration - o;
            this._start = s, this._duration = Math.floor(Math.max(r, t.duration)), this._total += o, this._loop = !!t.loop, this._to = fe([t.to, e, n, t.from]), this._from = fe([t.from, n, e])
        }
    }
    cancel() {
...
class Oo {
    ...
    configure(t) {
        ...
        Object.getOwnPropertyNames(t).forEach(n => {
            ...
            (V(o.properties) && o.properties || [n]).forEach(a => {
    ...
    _animateOptions(t, e) {
        ...
        return s.$shared && Dl(t.options.$animations, s).then(() => {
            t.options = s
        }, () => {}), o
    }
...
function Gs(i, t, e, s = {}) {
    ...
    for (r = 0, a = n.length; r < a; ++r) {
        ...
        c = i.values[l], U(c) && (o || t === 0 || mt(t) === mt(c)) && (t += c)
    }
    return !h && !s.all ? 0 : t
}
...
function Ll(i, t) {
    const {
        iScale: e,
        vScale: s
    } = t, n = e.axis === "x" ? "x" : "y", o = s.axis === "x" ? "x" : "y", r = Object.keys(i), a = new Array(r.length);
    let l, c, h;
...
function Zs(i, t) {
    const {
        ...
        vScale: r,
        index: a
    } = s, l = o.axis, c = r.axis, h = Rl(o, r, s), d = t.length;
    let u;
    for (let f = 0; f < d; ++f) {
        const g = t[f],
            {
        ...
        u = b[c] = Il(n, h, p), u[a] = m, u._top = Js(u, r, !0, s.type), u._bottom = Js(u, r, !1, s.type);
...
const Ai = i => i === "reset" || i === "none",
    Qs = (i, t) => t ? i : Object.assign({}, i),
    Bl = (i, t, e) => i && !t.hidden && t._stacked && {
        keys: Ao(e, !0),
        values: null
    };
class ht {
    ...
    linkScales() {
        const t = this.chart,
            ...
            o = e.xAxisID = A(s.xAxisID, Oi(t, "x")),
            r = e.yAxisID = A(s.yAxisID, Oi(t, "y")),
            a = e.rAxisID = A(s.rAxisID, Oi(t, "r")),
            l = e.indexAxis,
    ...
    _destroy() {
        const t = this._cachedMeta;
        this._data && Is(this._data, this), t._stacked && ae(t)
    }
    _dataCheck() {
        ...
        if (L(e)) {
            ...
            e && Object.isExtensible(e) && ka(e, this), this._syncList = [], this._data = e
        }
    }
    addElements() {
        const t = this._cachedMeta;
    ...
    buildOrUpdateElements(t) {
        ...
        this._dataCheck();
        const o = e._stacked;
        e._stacked = Di(e.vScale, e), e.stack !== s.stack && (n = !0, ae(e), e.stack = s.stack), this._resyncElements(t), (n || o !== e._stacked) && (Zs(this, e._parsed), e._stacked = Di(e.vScale, e))
    }
    configure() {
    ...
    updateRangeFromParsed(t, e, s, n) {
        ...
        n && a && (n.values = a, r = Gs(n, o, this._cachedMeta.index)), t.min = Math.min(t.min, r), t.max = Math.max(t.max, r)
    }
    getMinMax(t, e) {
    ...
    getAllParsedValues(t) {
        const e = this._cachedMeta._parsed,
            s = [];
        let n, o, r;
        for (n = 0, o = e.length; n < o; ++n) r = e[n][t.axis], U(r) && s.push(r);
        return s
    }
    getMaxOverflow() {
        return !1
    ...
    _update(t) {
        const e = this._cachedMeta;
        this.update(t || "default"), e._clip = Tl(A(this.options.clip, Al(e.xScale, e.yScale, this.getMaxOverflow())))
    }
    update(t) {}
    draw() {
        const t = this._ctx,
    ...
    getContext(t, e, s) {
        ...
        if (t >= 0 && t < this._cachedMeta.data.length) {
            ...
            o = r.$context || (r.$context = zl(this.getContext(), t, r)), o.parsed = this.getParsed(t), o.raw = n.data[t], o.index = o.dataIndex = t
        } else o = this.$context || (this.$context = Fl(this.chart.getContext(), this.index)), o.dataset = n, o.index = o.datasetIndex = this.index;
    ...
    _resolveElementOptions(t, e = "default", s) {
        const n = e === "active",
            ...
            r = t + "-" + e,
            a = o[r],
            l = this.enableOptionSharing && Se(s);
        if (a) return Qs(a, l);
        ...
        return p.$shared && (p.$shared = l, o[r] = Object.freeze(Qs(p, l))), p
    }
    _resolveAnimations(t, e, s) {
        ...
        const c = new Oo(n, l && l.animations);
    ...
    updateElement(t, e, s, n) {
        Ai(n) ? Object.assign(t, s) : this._resolveAnimations(e, n).update(t, s)
    }
    updateSharedOptions(t, e, s) {
        t && !Ai(e) && this._resolveAnimations(void 0, e).update(t, s)
    }
    _setStyle(t, e, s, n) {
        t.active = n;
...
w(ht, "defaults", {}), w(ht, "datasetElementType", null), w(ht, "dataElementType", null);
...
function Nl(i, t) {
    if (!i._cache.$bar) {
        ...
        i._cache.$bar = co(s.sort((n, o) => n - o))
    }
    return i._cache.$bar
}
...
function Wl(i) {
    ...
    let s = t._length,
        n, o, r, a;
    const l = () => {
        r === 32767 || r === -32768 || (Se(a) && (s = Math.min(s, Math.abs(r - a) || s)), a = r)
    };
...
function To(i, t, e, s) {
    return V(i) ? Hl(i, t, e, s) : t[e.axis] = e.parse(i, s), t
}
...
function tn(i, t, e, s) {
    const n = i.iScale,
        ...
        l = [];
    let c, h, d, u;
    for (c = e, h = e + s; c < h; ++c) u = t[c], d = {}, d[n.axis] = a || n.parse(r[c], c), l.push(To(u, d, o, c));
    return l
}
...
function Ul(i, t, e, s) {
    ...
    n === "middle" && e && (i.enableBorderRadius = !0, (e._top || 0) === s ? n = c : (e._bottom || 0) === s ? n = h : (o[en(h, r, a, l)] = !0, n = c)), o[en(n, r, a, l)] = !0, i.borderSkipped = o
}

function en(i, t, e, s) {
    return s ? (i = Xl(i, t, e), i = sn(i, e, t)) : i = sn(i, t, e), i
}
...
class Qe extends ht {
    ...
    parseObjectData(t, e, s, n) {
        ...
        let u, f, g, p;
        for (u = s, f = s + n; u < f; ++u) p = e[u], g = {}, g[o.axis] = o.parse(Rt(p, c), u), d.push(To(Rt(p, h), g, r, u));
        return d
    }
    updateRangeFromParsed(t, e, s, n) {
    ...
    getLabelAndValue(t) {
        const e = this._cachedMeta,
            ...
            o = this.getParsed(t),
            r = o._custom,
            a = Ti(r) ? "[" + r.start + ", " + r.end + "]" : "" + n.getLabelForValue(o[n.axis]);
        return {
        ...
        for (let f = e; f < e + s; f++) {
            const g = this.getParsed(f),
                ...
                x = {
                    horizontal: c,
                    base: p.base,
                    enableBorderRadius: !b || Ti(g._custom) || r === b._top || r === b._bottom,
                    x: c ? p.head : m.center,
                    y: c ? m.center : p.head,
            ...
            Ul(x, y, b, r), Kl(x, y, h.ratio), this.updateElement(t[f], f, x, n)
        }
    }
    _getStacks(t, e) {
        const {
            iScale: s
        } = this._cachedMeta, n = s.getMatchingVisibleMetas(this._type).filter(h => h.controller.options.grouped), o = s.options.stacked, r = [], a = this._cachedMeta.controller.getParsed(e), l = a && a[s.axis], c = h => {
            const d = h._parsed.find(f => f[s.axis] === l),
                u = d && d[h.vScale.axis];
            if (E(u) || isNaN(u)) return !0
        };
        for (const h of n)
    ...
    _calculateBarValuePixels(t) {
        ...
        } = this, a = o || 0, l = this.getParsed(t), c = l._custom, h = Ti(c);
        let d = l[e.axis],
            u = 0,
        ...
        if (b === e.getPixelForValue(a)) {
            const x = mt(p) * e.getLineWidthForValue(a) / 2;
            b += x, p -= x
        }
        return {
            size: p,
    ...
    _calculateBarIndexPixels(t, e) {
        const s = e.scale,
            n = this.options,
            o = n.skipNull,
            r = A(n.maxBarThickness, 1 / 0);
        let a, l;
        if (e.grouped) {
            const c = o ? this._getStackCount(t) : e.stackCount,
                h = n.barThickness === "flex" ? $l(t, e, n, c) : Vl(t, e, n, c),
    ...
    updateElements(t, e, s, n) {
        ...
        for (let u = e; u < e + s; u++) {
            const f = t[u],
                ...
                p = {},
                m = p[h] = o ? r.getPixelForDecimal(.5) : r.getPixelForValue(g[h]),
...
function ql(i, t, e) {
    ...
    if (t < $) {
        const a = i,
            ...
            d = Math.cos(l),
            u = Math.sin(l),
            f = (y, v, _) => Ce(y, a, l, !0) ? 1 : Math.max(v, v * e, _, _ * e),
            g = (y, v, _) => Ce(y, a, l, !0) ? -1 : Math.min(v, v * e, _, _ * e),
            p = f(0, c, d),
            m = f(X, h, u),
            b = g(H, c, d),
            x = g(H + X, h, u);
...
class jt extends ht {
    ...
    update(t) {
        const e = this.chart,
            ...
            l = Math.min(ca(this.options.cutout, a), 1),
    ...
    getLabelAndValue(t) {
        const e = this._cachedMeta,
            s = this.chart,
            n = s.data.labels || [],
            o = Re(e._parsed[t], s.options.locale);
        return {
            label: n[t] || "",
            value: o
        }
...
class ei extends ht {
    ...
    update(t) {
        ...
        this._drawStart = a, this._drawCount = l, go(e) && (a = 0, l = n.length), s._chart = this.chart, s._datasetIndex = this.index, s._decimated = !!o._decimated, s.points = n;
    ...
    updateElements(t, e, s, n) {
        const o = n === "reset",
            ...
            m = se(g) ? g : Number.POSITIVE_INFINITY,
        ...
        for (let _ = 0; _ < y; ++_) {
            ...
            const S = this.getParsed(_),
                C = E(S[f]),
                D = k[u] = r.getPixelForValue(S[u], _),
                O = k[f] = o || C ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, S, l) : S[f], _);
            k.skip = isNaN(D) || isNaN(O) || C, k.stop = _ > 0 && Math.abs(S[u] - v[u]) > m, p && (k.parsed = S, k.raw = c.data[_]), d && (k.options = h || this.resolveDataElementOptions(_, M.active ? "active" : n)), b || this.updateElement(M, _, k, n), v = S
        }
    }
    getMaxOverflow() {
        const t = this._cachedMeta,
...
class we extends ht {
    ...
    getLabelAndValue(t) {
        const e = this._cachedMeta,
            s = this.chart,
            n = s.data.labels || [],
            o = Re(e._parsed[t].r, s.options.locale);
        return {
            label: n[t] || "",
            value: o
        }
    ...
    updateElements(t, e, s, n) {
        ...
        for (g = e; g < e + s; g++) {
            ...
            let b = f,
                ...
                y = r.getDataVisibility(g) ? c.getDistanceFromCenterForValue(this.getParsed(g).r) : 0;
...
w(we, "id", "polarArea"), w(we, "defaults", {
    dataElementType: "arc",
    animation: {
        animateRotate: !0,
        animateScale: !0
...
class si extends ht {
    ...
    update(t) {
        ...
        if (this._drawStart = o, this._drawCount = r, go(e) && (o = 0, r = s.length), this.options.showLine) {
    ...
    updateElements(t, e, s, n) {
        const o = n === "reset",
            ...
            b = se(p) ? p : Number.POSITIVE_INFINITY,
        ...
        for (let v = e; v < e + s; ++v) {
            const _ = t[v],
                ...
                k = x ? _ : {},
                S = E(M[g]),
                C = k[f] = r.getPixelForValue(M[f], v),
                D = k[g] = o || S ? a.getBasePixel() : a.getPixelForValue(l ? this.applyStack(a, M, l) : M[g], v);
            k.skip = isNaN(C) || isNaN(D) || S, k.stop = v > 0 && Math.abs(M[f] - y[f]) > b, m && (k.parsed = M, k.raw = c.data[v]), u && (k.options = d || this.resolveDataElementOptions(v, _.active ? "active" : n)), x || this.updateElement(_, v, k, n), y = M
        }
...
function Zl(i, t, e, s) {
    ...
    if (a && t === a.axis && t !== "r" && r && o.length) {
        const l = a._reversePixels ? va : Mt;
        if (s) {
            if (n._sharedOptions) {
                const c = o[0],
...
function Li(i, t, e, s, n) {
    ...
    return !n && !i.isPointInArea(t) || Ee(i, e, t, function(a, l, c) {
        !n && !St(a, i.chartArea, 0) || a.inRange(t.x, t.y, s) && o.push({
            element: a,
            datasetIndex: l,
            index: c
        })
...
function Ri(i, t, e, s, n, o) {
    return !o && !i.isPointInArea(t) ? [] : e === "r" && !s ? tc(i, t, e, n) : ec(i, t, e, s, n, o)
}
    ...
    modes: {
        index(i, t, e, s) {
            const n = Vt(t, i),
                ...
                a = e.intersect ? Li(i, n, o, s, r) : Ri(i, n, o, !1, s, r),
                l = [];
        ...
        dataset(i, t, e, s) {
            const n = Vt(t, i),
                o = e.axis || "xy",
                r = e.includeInvisible || !1;
            let a = e.intersect ? Li(i, n, o, s, r) : Ri(i, n, o, !1, s, r);
            if (a.length > 0) {
...
function rc(i) {
    const t = sc(i),
        e = ce(t.filter(c => c.box.fullSize), !0),
        s = ce(le(t, "left"), !0),
        n = ce(le(t, "right")),
        o = ce(le(t, "top"), !0),
        r = ce(le(t, "bottom")),
...
function ac(i, t, e, s) {
    ...
    const a = Math.max(0, t.outerWidth - rn(r, i, "left", "right")),
        l = Math.max(0, t.outerHeight - rn(r, i, "top", "bottom")),
        c = a !== i.w,
        h = l !== i.h;
...
function ge(i, t, e, s) {
    ...
    for (o = 0, r = i.length, c = 0; o < r; ++o) {
        a = i[o], l = a.box, l.update(a.width || t.w, a.height || t.h, cc(a.horizontal, t));
        const {
            same: d,
            other: u
        } = ac(t, e, a, s);
...
function an(i, t, e, s) {
    ...
    for (const a of i) {
        ...
        if (a.horizontal) {
            const d = t.w * h,
                u = c.size || l.height;
            Se(c.start) && (r = c.start), l.fullSize ? Ye(l, n.left, r, e.outerWidth - n.right - n.left, u) : Ye(l, t.left + c.placed, r, d, u), c.start = r, c.placed += d, r = l.bottom
        } else {
            const d = t.h * h,
                u = c.size || l.width;
            Se(c.start) && (o = c.start), l.fullSize ? Ye(l, o, n.top, u, e.outerHeight - n.bottom - n.top) : Ye(l, o, t.top + c.placed, u, d), c.start = o, c.placed += d, o = l.right
        }
    }
    t.x = o, t.y = r
}
var Z = {
    ...
    update(i, t, e, s) {
        ...
        const f = Object.assign({
            ...
            g = oc(l.concat(c), d);
        ge(a.fullSize, f, d, g), ge(l, f, d, g), ge(c, f, d, g) && ge(l, f, d, g), lc(f), an(a.leftAndTop, f, d, g), f.x += f.w, f.y += f.h, an(a.rightAndBottom, f, d, g), i.chartArea = {
            left: f.left,
            top: f.top,
            right: f.left + f.w,
            bottom: f.top + f.h,
...
function uc(i, t) {
    ...
    if (i[ni] = {
        ...
        }, e.display = e.display || "block", e.boxSizing = e.boxSizing || "border-box", ln(n)) {
        const o = js(i, "width");
        o !== void 0 && (i.width = o)
    }
    if (ln(s))
...
function mc(i, t, e) {
    const s = i.canvas,
        n = new MutationObserver(o => {
            let r = !1;
            for (const a of o) r = r || gi(a.addedNodes, s), r = r && !gi(a.removedNodes, s);
            r && e()
        });
...
function bc(i, t, e) {
    const s = i.canvas,
        n = new MutationObserver(o => {
            let r = !1;
            for (const a of o) r = r || gi(a.removedNodes, s), r = r && !gi(a.addedNodes, s);
            r && e()
        });
    return n.observe(document, {
        childList: !0,
...
function Fo() {
    ...
    i !== cn && (cn = i, De.forEach((t, e) => {
        e.currentDevicePixelRatio !== i && t()
    }))
}

function xc(i, t) {
    De.size || window.addEventListener("resize", Fo), De.set(i, t)
}

function _c(i) {
    De.delete(i), De.size || window.removeEventListener("resize", Fo)
}
...
function yc(i, t, e) {
    ...
    return r.observe(n), xc(i, o), r
}

function Ei(i, t, e) {
    e && e.disconnect(), t === "resize" && _c(i)
}
...
class wc extends Eo {
    acquireContext(t, e) {
        ...
        return s && s.canvas === t ? (uc(t, e), s) : null
    }
    releaseContext(t) {
        const e = t.canvas;
        if (!e[ni]) return !1;
        const s = e[ni].initial;
...
function kc(i) {
    return !ps() || typeof OffscreenCanvas != "undefined" && i instanceof OffscreenCanvas ? hc : wc
}
class dt {
    constructor() {
        w(this, "x");
...
w(dt, "defaults", {}), w(dt, "defaultRoutes");

function Mc(i, t) {
    const e = i.options.ticks,
        s = Sc(i),
        n = Math.min(e.maxTicksLimit || s, s),
        o = e.major.enabled ? Pc(t) : [],
        r = o.length,
        a = o[0],
        l = o[r - 1],
        c = [];
    if (r > n) return Dc(t, c, o, r / n), c;
    const h = Cc(o, t, n);
    if (r > 0) {
        let d, u;
        const f = r > 1 ? Math.round((l - a) / (r - 1)) : null;
        for (Ue(t, c, h, E(f) ? 0 : a - f, a), d = 0, u = r - 1; d < u; d++) Ue(t, c, h, o[d], o[d + 1]);
        return Ue(t, c, h, l, E(f) ? t.length : l + f), c
    }
    return Ue(t, c, h), c
}
...
function Ue(i, t, e, s, n) {
    const o = A(s, 0),
        r = Math.min(A(n, i.length), i.length);
    let a = 0,
        l, c, h;
...
const Ac = i => i === "left" ? "right" : i === "right" ? "left" : i,
...
function Ic(i, t, e) {
    let s = cs(i);
    return (e && t !== "right" || !e && t === "right") && (s = Ac(s)), s
}
...
function Fc(i, t, e, s) {
    ...
    if (i.isHorizontal()) {
        ...
        } else e === "center" ? g = (c.bottom + c.top) / 2 + p - t : g = hn(i, e, t);
        u = a - o
    } else {
        if (L(e)) {
            const b = Object.keys(e)[0],
...
class Jt extends dt {
    ...
    update(t, e, s) {
        ...
        this._convertTicksToLabels(l ? un(this.ticks, a) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), r.display && (r.autoSkip || r.source === "auto") && (this.ticks = Mc(this, this.ticks), this._labelSizes = null, this.afterAutoSkip()), l && this._convertTicksToLabels(this.ticks), this.beforeFit(), this.fit(), this.afterFit(), this.afterUpdate()
    }
    configure() {
    ...
    generateTickLabels(t) {
        ...
        let s, n, o;
        for (s = 0, n = t.length; s < n; s++) o = t[s], o.label = W(e.callback, [o.value, s, t], this)
    }
    ...
    calculateLabelRotation() {
        ...
        a = t.offset ? this.maxWidth / s : f / (s - 1), d + 6 > a && (a = f / (s - (t.offset ? .5 : 1)), l = this.maxHeight - he(t.grid) - e.padding - fn(t.title, this.chart.options.font), c = Math.sqrt(d * d + u * u), r = as(Math.min(Math.asin(G((h.highest.height + 6) / a, -1, 1)), Math.asin(G(l / c, -1, 1)) - Math.asin(G(u / c, -1, 1)))), r = Math.max(n, Math.min(o, r))), this.labelRotation = r
    }
    ...
    _getLabelSizes() {
        ...
        if (!t) {
            ...
            let s = this.ticks;
            e < s.length && (s = un(s, e)), this._labelSizes = t = this._computeLabelSizes(s, s.length, this.options.ticks.maxTicksLimit)
        }
        return t
    }
    _computeLabelSizes(t, e, s) {
        const {
            ctx: n,
            _longestTextCache: o
        } = this, r = [], a = [], l = Math.floor(e / dn(e, s));
        let c = 0,
            h = 0,
            d, u, f, g, p, m, b, x, y, v, _;
        for (d = 0; d < e; d += l) {
            if (g = t[d].label, p = this._resolveTickFontOptions(d), n.font = m = p.string, b = o[m] = o[m] || {
                    data: {},
                    gc: []
                }, x = p.lineHeight, y = v = 0, !E(g) && !V(g)) y = ui(n, b.data, b.gc, y, g), v = x;
            else if (V(g))
                for (u = 0, f = g.length; u < f; ++u) _ = g[u], !E(_) && !V(_) && (y = ui(n, b.data, b.gc, y, _), v += x);
    ...
    getPixelForDecimal(t) {
        ...
        return ya(this._alignToPixels ? Bt(this.chart, e, 0) : e)
    }
    ...
    getContext(t) {
        ...
        if (t >= 0 && t < e.length) {
            const s = e[t];
            return s.$context || (s.$context = Ec(this.getContext(), t, s))
        }
    ...
    _computeGridLineItems(t) {
        ...
        let x, y, v, _, M, k, S, C, D, O, T, R;
        if (r === "top") x = b(this.bottom), k = this.bottom - u, C = x - m, O = b(t.top) + m, R = t.bottom;
        else if (r === "bottom") x = b(this.top), O = t.top, R = b(t.bottom) - m, k = x + m, C = this.top + u;
        else if (r === "left") x = b(this.right), M = this.right - u, S = x - m, D = b(t.left) + m, T = t.right;
        else if (r === "right") x = b(this.left), D = t.left, T = b(t.right) - m, M = x + m, S = this.left + u;
        else if (e === "x") {
            if (r === "center") x = b((t.top + t.bottom) / 2 + .5);
            else if (L(r)) {
                const N = Object.keys(r)[0],
                    Y = r[N];
                x = b(this.chart.scales[N].getPixelForValue(Y))
            }
            O = t.top, R = t.bottom, k = x + m, C = k + u
        } else if (e === "y") {
        ...
        const tt = A(n.ticks.maxTicksLimit, d),
        ...
        for (y = 0; y < d; y += F) {
            const N = this.getContext(y),
                ...
                bt = Y.tickColor,
                Ft = Y.tickBorderDash || [],
                ft = Y.tickBorderDashOffset;
            v = Tc(this, y, l), v !== void 0 && (_ = Bt(s, v, K), c ? M = S = D = T = _ : k = C = O = R = _, f.push({
                tx1: M,
                ty1: k,
                tx2: S,
                ty2: C,
    ...
    _computeLabelItems(t) {
        const e = this.axis,
            ...
            m = [];
        let b, x, y, v, _, M, k, S, C, D, O, T, R = "middle";
        if (n === "top") M = this.bottom - g, k = this._getXAxisLabelAlignment();
            ...
            if (n === "center") M = (t.top + t.bottom) / 2 + f;
                ...
                const F = Object.keys(n)[0],
                    N = n[F];
                M = this.chart.scales[F].getPixelForValue(N) + f
            }
            ...
            if (n === "center") _ = (t.left + t.right) / 2 - f;
                ...
                const F = Object.keys(n)[0],
                    N = n[F];
                _ = this.chart.scales[F].getPixelForValue(N)
            }
        ...
        for (b = 0, x = a.length; b < x; ++b) {
            ...
            S = this.getPixelForTick(b) + o.labelOffset, C = this._resolveTickFontOptions(b), D = C.lineHeight, O = V(v) ? v.length : 1;
            const N = O / 2,
                Y = F.color,
                et = F.textStrokeColor,
                K = F.textStrokeWidth;
            let Ct = k;
            r ? (_ = S, k === "inner" && (b === x - 1 ? Ct = this.options.reverse ? "left" : "right" : b === 0 ? Ct = this.options.reverse ? "right" : "left" : Ct = "center"), n === "top" ? c === "near" || p !== 0 ? T = -O * D + D / 2 : c === "center" ? T = -tt.highest.height / 2 - N * D + D : T = -tt.highest.height + D / 2 : c === "near" || p !== 0 ? T = D / 2 : c === "center" ? T = tt.highest.height / 2 - N * D : T = tt.highest.height - O * D, d && (T *= -1), p !== 0 && !F.showLabelBackdrop && (_ += D / 2 * Math.sin(p))) : (M = S, T = (1 - O) * D / 2);
            let Zt;
            if (F.showLabelBackdrop) {
                const ut = Q(F.backdropPadding),
                    Pt = tt.heights[b],
                    bt = tt.widths[b];
                let Ft = T - ut.top,
                    ft = 0 - ut.left;
    ...
    drawBorder() {
        ...
        const a = n.setContext(this.getContext(0)).lineWidth,
            l = this._borderValue;
        let c, h, d, u;
        this.isHorizontal() ? (c = Bt(t, this.left, r) - r / 2, h = Bt(t, this.right, a) + a / 2, d = u = l) : (d = Bt(t, this.top, r) - r / 2, u = Bt(t, this.bottom, a) + a / 2, c = h = l), e.save(), e.lineWidth = o.width, e.strokeStyle = o.color, e.beginPath(), e.moveTo(c, d), e.lineTo(h, u), e.stroke(), e.restore()
    }
    drawLabels(t) {
    ...
    drawTitle() {
        ...
        e === "bottom" || e === "center" || L(e) ? (l += r.bottom, V(s.text) && (l += o.lineHeight * (s.text.length - 1))) : l += r.top;
        const {
            titleX: c,
            titleY: h,
            maxWidth: d,
    ...
    _layers() {
        const t = this.options,
            ...
            s = A(t.grid && t.grid.z, -1),
            n = A(t.border && t.border.z, 0);
...
class Xe {
    ...
    register(t) {
        ...
        let s;
        Nc(e) && (s = this.register(e));
        const n = this.items,
            o = t.id,
            r = this.scope + "." + o;
        if (!o) throw new Error("class does not have id: " + t);
        return o in n || (n[o] = t, zc(t, r, s), this.override && j.override(t.id, t.overrides)), r
    }
    get(t) {
        return this.items[t]
    }
...
function zc(i, t, e) {
    const s = Me(Object.create(null), [e ? j.get(e) : {}, j.get(t), i.defaults]);
    j.set(t, s), i.defaultRoutes && Bc(t, i.defaultRoutes), i.descriptors && j.describe(t, i.descriptors)
}
...
class Wc {
    constructor() {
        this.controllers = new Xe(ht, "datasets", !0), this.elements = new Xe(dt, "elements"), this.plugins = new Xe(Object, "plugins"), this.scales = new Xe(Jt, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
    }
    add(...t) {
...
class Vc {
    ...
    _createDescriptors(t, e) {
        const s = t && t.config,
            n = A(s.options && s.options.plugins, {}),
            o = $c(s);
        return n === !1 && !e ? [] : jc(t, o, n, e)
    }
...
function $c(i) {
    ...
    for (let o = 0; o < s.length; o++) e.push(pt.getPlugin(s[o]));
    const n = i.plugins || [];
...
function Ui(i, ...t) {
    if (gn(i)) return i;
    for (const e of t) {
        const s = e.axis || Kc(e.position) || i.length > 1 && gn(i[0].toLowerCase());
        if (s) return s
    }
...
function Gc(i, t) {
    ...
    return Object.keys(s).forEach(r => {
        ...
        const l = Ui(r, a, qc(r, i), j.scales[a.type]),
            c = Xc(l, n),
            h = e.scales || {};
        o[r] = xe(Object.create(null), [{
            axis: l
        }, a, h[l], h[c]])
    }), i.data.datasets.forEach(r => {
        const a = r.type || i.type,
            l = r.indexAxis || Yi(a, t),
            h = (qt[a] || {}).scales || {};
        Object.keys(h).forEach(d => {
            const u = Uc(d, l),
                f = r[u + "AxisID"] || u;
            o[f] = o[f] || Object.create(null), xe(o[f], [{
                axis: u
            }, s[f], h[d]])
        })
    }), Object.keys(o).forEach(r => {
        const a = o[r];
        xe(a, [j.scales[a.type], j.scale])
    }), o
}

function zo(i) {
    const t = i.options || (i.options = {});
    t.plugins = A(t.plugins, {}), t.scales = Gc(i, t)
}
...
function Ke(i, t) {
    let e = mn.get(i);
    return e || (e = t(), mn.set(i, e), No.add(e)), e
}
const de = (i, t, e) => {
    const s = Rt(t, e);
    s !== void 0 && i.add(s)
...
class Zc {
    constructor(t) {
        this._config = Jc(t), this._scopeCache = new Map, this._resolverCache = new Map
    }
    get platform() {
    ...
    getOptionScopes(t, e, s) {
        ...
        const l = new Set;
        e.forEach(h => {
            t && (l.add(t), h.forEach(d => de(l, t, d))), h.forEach(d => de(l, n, d)), h.forEach(d => de(l, qt[o] || {}, d)), h.forEach(d => de(l, j, d)), h.forEach(d => de(l, $i, d))
        });
        const c = Array.from(l);
        return c.length === 0 && c.push(Object.create(null)), No.has(e) && r.set(e, c), c
    }
    chartOptionScopes() {
        const {
            options: t,
...
const Qc = i => L(i) && Object.getOwnPropertyNames(i).some(t => Et(i[t]));
...
function xn(i, t) {
    return i === "top" || i === "bottom" || ih.indexOf(i) === -1 && t === "x"
}
...
class wt {
    ...
    constructor(t, e) {
        ...
        const a = this.platform.acquireContext(n, r.aspectRatio),
            ...
            c = l && l.height,
            h = l && l.width;
        if (this.id = la(), this.ctx = a, this.canvas = l, this.width = h, this.height = c, this._options = r, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new Vc, this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = Ma(d => this.update(d), r.resizeDelay || 0), this._dataChanges = [], oi[this.id] = this, !a || !l) {
            console.error("Failed to create chart: can't acquire context from the given item");
            return
        }
        _t.listen(this, "complete", yn), _t.listen(this, "progress", sh), this._initialize(), this.attached && this.update()
    }
    get aspectRatio() {
        const {
            options: {
    ...
    _resize(t, e) {
        ...
        this.width = r.width, this.height = r.height, this._aspectRatio = this.aspectRatio, Hs(this, a, !0) && (this.notifyPlugins("resize", {
            size: r
        }), W(s.onResize, [this, r], this), this.attached && this._doResize(l) && this.render())
    }
    ensureScalesHaveIDs() {
    ...
    buildOrUpdateScales() {
        ...
        e && (o = o.concat(Object.keys(e).map(r => {
            ...
            const a = r.options,
                ...
                c = Ui(l, a),
                h = A(a.type, r.dtype);
            (a.position === void 0 || xn(a.position, c) !== xn(r.dposition)) && (a.position = r.dposition), n[l] = !0;
            let d = null;
    ...
    buildOrUpdateControllers() {
        ...
        for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
            ...
            if (r.type && r.type !== a && (this._destroyDatasetMeta(s), r = this.getDatasetMeta(s)), r.type = a, r.indexAxis = o.indexAxis || Yi(a, this.options), r.order = o.order || 0, r.index = s, r.label = "" + o.label, r.visible = this.isDatasetVisible(s), r.controller) r.controller.updateIndex(s), r.controller.linkScales();
            else {
    ...
    _checkEventBindings() {
        const t = this.options,
            ...
            s = new Set(t.events);
        (!Ts(e, s) || !!this._responsiveListeners !== t.responsive) && (this.unbindEvents(), this.bindEvents())
    }
    ...
    _updateDatasets(t) {
        if (this.notifyPlugins("beforeDatasetsUpdate", {
            ...
            for (let e = 0, s = this.data.datasets.length; e < s; ++e) this._updateDataset(e, Et(t) ? t({
                datasetIndex: e
            }) : t);
    ...
    render() {
        this.notifyPlugins("beforeRender", {
            cancelable: !0
        }) !== !1 && (_t.has(this) ? this.attached && !_t.running(this) && _t.start(this) : (this.draw(), yn({
            chart: this
        })))
    }
    draw() {
    ...
    _drawDataset(t) {
        const e = this.ctx,
            s = t._clip,
            n = !s.disabled,
            o = rh(t, this.chartArea),
            r = {
                meta: t,
                index: t.index,
                cancelable: !0
            };
        this.notifyPlugins("beforeDatasetDraw", r) !== !1 && (n && _i(e, {
        ...
        }), t.controller.draw(), n && yi(e), r.cancelable = !1, this.notifyPlugins("afterDatasetDraw", r))
    }
    isPointInArea(t) {
        return St(t, this.chartArea, this._minPadding)
    }
    ...
    _updateVisibility(t, e, s) {
        ...
        Se(e) ? (o.data[e].hidden = !s, this.update()) : (this.setDatasetVisibility(t, s), r.update(o, {
            visible: s
    ...
    destroy() {
        ...
        this._stop(), this.config.clearCache(), t && (this.unbindEvents(), Ws(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), delete oi[this.id], this.notifyPlugins("afterDestroy")
    }
    toBase64Image(...t) {
    ...
    setActiveElements(t) {
        ...
        !ci(s, e) && (this._active = s, this._lastEvent = null, this._updateHoverStyles(s, e))
    }
    notifyPlugins(t, e, s) {
    ...
    _handleEvent(t, e, s) {
        const {
            _active: n = [],
            options: o
        } = this, r = e, a = this._getActiveElements(t, n, s, r), l = ga(t), c = oh(t, this._lastEvent, s, l);
        s && (this._lastEvent = null, W(o.onHover, [t, a, this], this), l && W(o.onClick, [t, a, this], this));
        const h = !ci(a, n);
...
w(wt, "defaults", j), w(wt, "instances", oi), w(wt, "overrides", qt), w(wt, "registry", pt), w(wt, "version", eh), w(wt, "getChart", vn);

function wn() {
    return z(wt.instances, i => i._plugins.invalidate())
}
...
function ah(i, t, e) {
    ...
    let c = n / a;
    i.beginPath(), i.arc(o, r, a, s - c, e + c), l > n ? (c = n / l, i.arc(o, r, l, e + c, s - c, !0)) : i.arc(o, r, n, e + X, s - X), i.closePath(), i.clip()
}

function lh(i) {
    return ds(i, ["outerStart", "outerEnd", "innerStart", "innerEnd"])
}

function ch(i, t, e, s) {
    const n = lh(i.options.borderRadius),
        o = (e - t) / 2,
        r = Math.min(o, s * t / 2),
        a = l => {
            const c = (e - Math.min(o, l)) * s / 2;
            return G(l, 0, Math.min(o, c))
        };
    return {
        outerStart: a(n.outerStart),
        outerEnd: a(n.outerEnd),
        innerStart: G(n.innerStart, 0, r),
        innerEnd: G(n.innerEnd, 0, r)
    }
}
...
function pi(i, t, e, s, n, o) {
    ...
    if (i.beginPath(), o) {
        const F = (C + D) / 2;
        if (i.arc(r, a, d, C, F), i.arc(r, a, d, F, D), v > 0) {
            const K = ee(S, D, r, a);
            i.arc(K.x, K.y, v, D, x + X)
        }
        const N = ee(T, x, r, a);
        if (i.lineTo(N.x, N.y), M > 0) {
            const K = ee(T, tt, r, a);
            i.arc(K.x, K.y, M, x + X, tt + Math.PI)
        }
        const Y = (x - M / u + (b + _ / u)) / 2;
        if (i.arc(r, a, u, x - M / u, Y, !0), i.arc(r, a, u, Y, b + _ / u, !0), _ > 0) {
            const K = ee(O, R, r, a);
            i.arc(K.x, K.y, _, R + Math.PI, b - X)
        }
        const et = ee(k, b, r, a);
        if (i.lineTo(et.x, et.y), y > 0) {
            const K = ee(k, C, r, a);
            i.arc(K.x, K.y, y, b - X, C)
        }
    } else {
        i.moveTo(r, a);
...
function dh(i, t, e, s, n) {
    ...
    f && ah(i, t, g), o || (pi(i, t, e, s, g, n), i.stroke())
}
class pe extends dt {
    constructor(e) {
        super();
    ...
    getCenterPoint(e) {
        const {
            ...
            offset: c,
            spacing: h
        } = this.options, d = (o + r) / 2, u = (a + l + h + c) / 2;
        return {
            x: s + Math.cos(d) * u,
            y: n + Math.sin(d) * u
        }
    ...
    draw(e) {
        const {
            options: s,
            circumference: n
        } = this, o = (s.offset || 0) / 4, r = (s.spacing || 0) / 2, a = s.circular;
        if (this.pixelMargin = s.borderAlign === "inner" ? .33 : 0, this.fullCircles = n > $ ? Math.floor(n / $) : 0, n === 0 || this.innerRadius < 0 || this.outerRadius < 0) return;
        e.save();
        const l = (this.startAngle + this.endAngle) / 2;
        e.translate(Math.cos(l) * o, Math.sin(l) * o);
        const c = 1 - Math.sin(Math.min(H, n || 0)),
            h = o * c;
        e.fillStyle = s.backgroundColor, e.strokeStyle = s.borderColor, hh(e, this, h, r, a), dh(e, this, h, r, a), e.restore()
    }
}
...
function fh(i) {
    return i.stepped ? Fa : i.tension || i.cubicInterpolationMode === "monotone" ? za : uh
}
...
function mh(i) {
    return i.stepped ? pl : i.tension || i.cubicInterpolationMode === "monotone" ? ml : $t
}
...
function xh(i, t, e, s) {
    ...
    for (const a of n) Vo(i, o, a.style), i.beginPath(), r(i, t, a, {
        start: e,
        end: e + s - 1
    }) && i.closePath(), i.stroke()
}
const _h = typeof Path2D == "function";

function yh(i, t, e, s) {
    _h && !t.options.segment ? bh(i, t, e, s) : xh(i, t, e, s)
}
class At extends dt {
    constructor(t) {
    ...
    updateControlPoints(t, e) {
        ...
        if ((s.tension || s.cubicInterpolationMode === "monotone") && !s.stepped && !this._pointsUpdated) {
            ...
            al(this._points, s, t, n, e), this._pointsUpdated = !0
        }
    }
    set points(t) {
    ...
    draw(t, e, s, n) {
        ...
        (this.points || []).length && o.borderWidth && (t.save(), yh(t, this, s, n), t.restore()), this.animated && (this._pointsUpdated = !1, this._path = void 0)
    }
}
w(At, "id", "line"), w(At, "defaults", {
    borderCapStyle: "butt",
    borderDash: [],
    borderDashOffset: 0,
...
class ri extends dt {
    ...
    draw(e, s) {
        ...
        this.skip || n.radius < .1 || !St(this, s, this.size(n) / 2) || (e.strokeStyle = n.borderColor, e.lineWidth = n.borderWidth, e.fillStyle = n.backgroundColor, Hi(e, n, this.x, this.y))
    }
    getRange() {
...
function vh(i, t, e) {
    const s = i.options.borderWidth,
        ...
        o = bo(s);
    return {
        t: Tt(n.top, o.top, 0, e),
        r: Tt(n.right, o.right, 0, t),
        b: Tt(n.bottom, o.bottom, 0, e),
        l: Tt(n.left, o.left, 0, t)
    }
}
...
function wh(i, t, e) {
    ...
    } = i.getProps(["enableBorderRadius"]), n = i.options.borderRadius, o = Xt(n), r = Math.min(t, e), a = i.borderSkipped, l = s || L(n);
    return {
        topLeft: Tt(!l || a.top || a.left, o.topLeft, 0, r),
        topRight: Tt(!l || a.top || a.right, o.topRight, 0, r),
        bottomLeft: Tt(!l || a.bottom || a.left, o.bottomLeft, 0, r),
        bottomRight: Tt(!l || a.bottom || a.right, o.bottomRight, 0, r)
    }
}
...
function Ii(i, t, e, s) {
    const n = t === null,
        o = e === null,
        a = i && !(n && o) && Ho(i, s);
    return a && (n || kt(t, a.left, a.right)) && (o || kt(e, a.top, a.bottom))
}
...
class ai extends dt {
    ...
    draw(t) {
        const {
            ...
            inner: o,
            outer: r
        } = kh(this), a = Mh(r.radius) ? Pe : Sh;
        t.save(), (r.w !== o.w || r.h !== o.h) && (t.beginPath(), a(t, Fi(r, e, o)), t.clip(), a(t, Fi(o, -e, r)), t.fillStyle = s, t.fill("evenodd")), t.beginPath(), a(t, Fi(o, e)), t.fillStyle = n, t.fill(), t.restore()
    }
    inRange(t, e, s) {
...
const Ki = ["rgb(54, 162, 235)", "rgb(255, 99, 132)", "rgb(255, 159, 64)", "rgb(255, 205, 86)", "rgb(75, 192, 192)", "rgb(153, 102, 255)", "rgb(201, 203, 207)"],
    Mn = Ki.map(i => i.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
...
function Ph(i, t) {
    return i.borderColor = jo(t), i.backgroundColor = Yo(t), ++t
}
...
function Ah(i) {
    ...
    return (e, s) => {
        ...
        n instanceof jt ? t = Dh(e, t) : n instanceof we ? t = Oh(e, t) : n && (t = Ph(e, t))
    }
}
...
function Eh(i, t, e, s, n) {
    ...
    for (r[l++] = i[h], d = 0; d < o - 2; d++) {
        let m = 0,
            b = 0,
            x;
        const y = Math.floor((d + 1) * a) + 1 + t,
            v = Math.min(Math.floor((d + 2) * a) + 1, e) + t,
            _ = v - y;
        for (x = y; x < v; x++) m += i[x].x, b += i[x].y;
        m /= _, b /= _;
        ...
        for (f = g = -1, x = M; x < k; x++) g = .5 * Math.abs((S - m) * (i[x].y - C) - (S - i[x].x) * (b - C)), g > f && (f = g, u = i[x], p = x);
        r[l++] = u, h = p
    }
    return r[l++] = i[c], r
}
        ...
        if (_ === h) c < g ? (g = c, d = r) : c > p && (p = c, u = r), n = (o * n + a.x) / ++o;
            ...
            if (!E(d) && !E(u)) {
                const k = Math.min(d, u),
                    S = Math.max(d, u);
                k !== f && k !== M && m.push(Fe(Ie({}, i[k]), {
                    x: n
                })), S !== f && S !== M && m.push(Fe(Ie({}, i[S]), {
                    x: n
                }))
            }
...
function Fh(i, t) {
    ...
    return l && (s = G(Mt(t, o.axis, r).lo, 0, e - 1)), c ? n = G(Mt(t, o.axis, a).hi + 1, s, e) - s : n = e - s, {
        start: s,
        count: n
    }
}
var zh = {
    ...
    beforeElementsUpdate: (i, t, e) => {
        ...
        i.data.datasets.forEach((n, o) => {
            ...
            if (fe([a, i.options.indexAxis]) === "y" || !l.controller.supportsDecimation) return;
...
function Bh(i, t, e) {
    ...
    for (const a of s) {
        ...
        const d = Do(t, h);
        for (const u of d) {
            const f = qi(e, o[u.start], o[u.end], u.loop),
                g = Po(a, n, f);
...
function Xo(i, t) {
    let e = [],
        s = !1;
    return V(i) ? (s = !0, e = i) : e = Nh(i, t), e.length ? new At({
        points: e,
        options: {
            tension: 0
        },
...
function Vh(i, t, e) {
    const s = Yh(i);
    if (L(s)) return isNaN(s.value) ? !1 : s;
    let n = parseFloat(s);
    return U(n) && Math.floor(n) === n ? $h(s[0], t, n, e) : ["origin", "start", "end", "stack", "shape"].indexOf(s) >= 0 && s
}
...
function Uh(i) {
    const {
        ...
        index: e,
        line: s
    } = i, n = [], o = s.segments, r = s.points, a = Xh(t, e);
    a.push(Xo({
        x: null,
        y: t.bottom
    }, s));
    for (let l = 0; l < o.length; l++) {
        const c = o[l];
        for (let h = c.start; h <= c.end; h++) Kh(n, r[h], a)
    }
    return new At({
        points: n,
        options: {}
...
function Gh(i) {
    ...
    if (U(e)) return Jh(t, e);
    if (e === "stack") return Uh(i);
    if (e === "shape") return !0;
    const n = Zh(i);
    return n instanceof Ko ? n : Xo(n, s)
}
...
function Zh(i) {
    return (i.scale || {}).getPointPositionForValue ? td(i) : Qh(i)
}
...
function td(i) {
    const {
        scale: t,
        fill: e
    } = i, s = t.options, n = t.getLabels().length, o = s.reverse ? t.max : t.min, r = jh(e, t, o), a = [];
    if (s.grid.circular) {
...
function ed(i, t) {
    ...
    i.save(), l === "x" && o !== n && (On(i, s, r.top), An(i, {
        line: e,
        target: s,
        color: n,
        scale: a,
        property: l
    }), i.restore(), i.save(), On(i, s, r.bottom)), An(i, {
        line: e,
        target: s,
        color: o,
        scale: a,
...
function An(i, t) {
    ...
    for (const {
        ...
        i.save(), i.fillStyle = u, id(i, r, f && qi(n, h, d)), i.beginPath();
        const g = !!e.pathSegment(i, l);
        let p;
        if (f) {
            g ? i.closePath() : Tn(i, s, d, n);
...
var sd = {
    ...
    afterDatasetsUpdate(i, t, e) {
        const s = (i.data.datasets || []).length,
            n = [];
        let o, r, a, l;
        for (r = 0; r < s; ++r) o = i.getDatasetMeta(r), a = o.dataset, l = null, a && a.options && a instanceof At && (l = {
        ...
        for (r = 0; r < s; ++r) l = n[r], !(!l || l.fill === !1) && (l.fill = Wh(n, r, e.propagate))
    },
    beforeDraw(i, t, e) {
        ...
        for (let r = n.length - 1; r >= 0; --r) {
            const a = n[r].$filler;
            a && (a.line.updateControlPoints(o, a.axis), s && a.fill && zi(i.ctx, a, o))
        }
    },
    beforeDatasetsDraw(i, t, e) {
        ...
        for (let n = s.length - 1; n >= 0; --n) {
            const o = s[n].$filler;
            Dn(o) && zi(i.ctx, o, i.chartArea)
        }
    },
    beforeDatasetDraw(i, t, e) {
        const s = t.meta.$filler;
        !Dn(s) || e.drawTime !== "beforeDatasetDraw" || zi(i.ctx, s, i.chartArea)
    },
    defaults: {
        propagate: !0,
...
const Ln = (i, t) => {
    ...
    nd = (i, t) => i !== null && t !== null && i.datasetIndex === t.datasetIndex && i.index === t.index;
class Rn extends dt {
    constructor(t) {
    ...
    adjustHitBoxes() {
        ...
        const t = this._computeTitleHeight(),
            ...
            r = ie(o, this.left, this.width);
        if (this.isHorizontal()) {
            let a = 0,
                l = J(s, this.left + n, this.right - this.lineWidths[a]);
            for (const c of e) a !== c.row && (a = c.row, l = J(s, this.left + n, this.right - this.lineWidths[a])), c.top += this.top + t + n, c.left = r.leftForLtr(r.x(l), c.width), l += c.width + n
        } else {
            let a = 0,
                l = J(s, this.top + t + n, this.bottom - this.columnSizes[a].height);
            for (const c of e) c.col !== a && (a = c.col, l = J(s, this.top + t + n, this.bottom - this.columnSizes[a].height)), c.top = l, c.left += this.left + n, c.left = r.leftForLtr(r.x(c.left), c.width), l += c.height + n
        }
    }
    isHorizontal() {
    ...
    _draw() {
        const {
            ...
            align: o,
            labels: r
        } = t, a = j.color, l = ie(t.rtl, this.left, this.width), c = q(r.font), {
            padding: h
        } = r, d = c.size, u = d / 2;
        let f;
        ...
        const {
            ...
            boxHeight: p,
            itemHeight: m
        } = Ln(r, d), b = function(M, k, S) {
            if (isNaN(g) || g <= 0 || isNaN(p) || p < 0) return;
            n.save();
            const C = A(S.lineWidth, 1);
            if (n.fillStyle = A(S.fillStyle, a), n.lineCap = A(S.lineCap, "butt"), n.lineDashOffset = A(S.lineDashOffset, 0), n.lineJoin = A(S.lineJoin, "miter"), n.lineWidth = C, n.strokeStyle = A(S.strokeStyle, a), n.setLineDash(A(S.lineDash, [])), r.usePointStyle) {
                const D = {
                    ...
                    O = l.xPlus(M, g / 2),
                    T = k + u;
                mo(n, D, O, T, r.pointStyleWidth && g)
            } else {
                const D = k + Math.max((d - p) / 2, 0),
                    O = l.leftForLtr(M, g),
                    T = Xt(S.borderRadius);
                n.beginPath(), Object.values(T).some(R => R !== 0) ? Pe(n, {
                    x: O,
                    y: D,
                    w: g,
                    h: p,
                    radius: T
                }) : n.rect(O, D, g, p), n.fill(), C !== 0 && n.stroke()
            }
            n.restore()
        }, x = function(M, k, S) {
            Gt(n, S.text, M, k + m / 2, c, {
        ...
        this.legendItems.forEach((M, k) => {
            ...
            let O = f.x,
                T = f.y;
            l.setWidth(this.width), y ? k > 0 && O + D + h > this.right && (T = f.y += _, f.line++, O = f.x = J(o, this.left + h, this.right - s[f.line])) : k > 0 && T + _ > this.bottom && (O = f.x = O + e[f.line].width + h, f.line++, T = f.y = J(o, this.top + v + h, this.bottom - e[f.line].height));
            const R = l.x(O);
            if (b(R, T, M), O = Sa(C, O + g + u, y ? O + D : this.right, t.rtl), x(l.x(O), T, M), y) f.x += D + h;
    ...
    drawTitle() {
        const t = this.options,
            ...
            n = Q(e.padding);
        if (!e.display) return;
        const o = ie(t.rtl, this.left, this.width),
            r = this.ctx,
            a = e.position,
            l = s.size / 2,
            c = n.top + l;
        let h, d = this.left,
            u = this.width;
        if (this.isHorizontal()) u = Math.max(...this.lineWidths), h = this.top + c, d = J(t.align, d, this.right - u);
        else {
        ...
        const f = J(a, d, d + u);
        r.textAlign = o.textAlign(cs(a)), r.textBaseline = "middle", r.strokeStyle = e.color, r.fillStyle = e.color, r.font = s.string, Gt(r, e.text, f, h, s)
    }
    _computeTitleHeight() {
    ...
    _getLegendItemAt(t, e) {
        ...
        if (kt(t, this.left, this.right) && kt(e, this.top, this.bottom)) {
            for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
                if (n = o[s], kt(t, n.left, n.left + n.width) && kt(e, n.top, n.top + n.height)) return this.legendItems[s]
        }
        return null
    }
    handleEvent(t) {
        const e = this.options;
        if (!ld(t.type, e)) return;
        const s = this._getLegendItemAt(t.x, t.y);
        if (t.type === "mousemove" || t.type === "mouseout") {
            const n = this._hoveredItem,
                o = nd(n, s);
            n && !o && W(e.onLeave, [t, n, this], this), this._hoveredItem = s, s && !o && W(e.onHover, [t, s, this], this)
        } else s && W(e.onClick, [t, s, this], this)
    }
}

function od(i, t, e, s, n) {
    const o = rd(s, i, t, e),
        r = ad(n, s, t.lineHeight);
    return {
        itemWidth: o,
        itemHeight: r
    }
...
function ad(i, t, e) {
    let s = i;
    return typeof t.text != "string" && (s = qo(t, e)), s
}
...
class _s extends dt {
    ...
    update(t, e) {
        ...
        const o = n * q(s.font).lineHeight + this._padding.height;
    ...
    _drawArgs(t) {
        ...
        let l = 0,
            c, h, d;
        return this.isHorizontal() ? (h = J(a, s, o), d = e + t, c = o - s) : (r.position === "left" ? (h = s + t, d = J(a, n, e), l = H * -.5) : (h = o - t, d = J(a, e, n), l = H * .5), c = n - e), {
            titleX: h,
            titleY: d,
            maxWidth: c,
            rotation: l
...
var ud = {
    ...
    start(i, t, e) {
        ...
        Z.configure(i, s, e), Z.addBox(i, s), Ge.set(i, s)
    },
    stop(i) {
        Z.removeBox(i, Ge.get(i)), Ge.delete(i)
    },
    beforeUpdate(i, t, e) {
        const s = Ge.get(i);
        Z.configure(i, s, e), s.options = e
...
function En(i, t) {
    ...
    return e.save(), e.font = c.string, z(i.title, y), e.font = l.string, z(i.beforeBody.concat(i.afterBody), y), x = t.displayColors ? r + 2 + t.boxPadding : 0, z(s, v => {
        z(v.before, y), z(v.lines, y), z(v.after, y)
    }), x = 0, e.font = h.string, z(i.footer, y), e.restore(), m += g.width, {
        width: m,
        height: p
    }
}
...
function md(i, t, e, s) {
    ...
    let c = "center";
    return s === "center" ? c = n <= (a + l) / 2 ? "left" : "right" : n <= o / 2 ? c = "left" : n >= r - o / 2 && (c = "right"), pd(c, i, t, e) && (c = "center"), c
}

function In(i, t, e) {
    const s = e.yAlign || t.yAlign || gd(i, e);
    return {
        xAlign: e.xAlign || t.xAlign || md(i, t, e, s),
        yAlign: s
    }
}
...
function Fn(i, t, e, s) {
    ...
    return l === "center" ? a === "left" ? g += c : a === "right" && (g -= c) : a === "left" ? g -= Math.max(h, u) + n : a === "right" && (g += Math.max(d, f) + n), {
        x: G(g, 0, s.width - t.width),
        y: G(p, 0, s.height - t.height)
    }
}
...
function st(i, t, e, s) {
    ...
    return typeof n == "undefined" ? Go[t].call(e, s) : n
}
class Gi extends dt {
    constructor(t) {
    ...
    getTitle(t, e) {
        const {
            callbacks: s
        } = e, n = st(s, "beforeTitle", this, t), o = st(s, "title", this, t), r = st(s, "afterTitle", this, t);
        let a = [];
        return a = gt(a, yt(n)), a = gt(a, yt(o)), a = gt(a, yt(r)), a
    }
    getBeforeBody(t, e) {
        return zn(st(e.callbacks, "beforeBody", this, t))
    }
    getBody(t, e) {
        const {
            callbacks: s
        ...
        return z(t, o => {
            const r = {
                ...
                a = Bn(s, o);
            gt(r.before, yt(st(a, "beforeLabel", this, o))), gt(r.lines, st(a, "label", this, o)), gt(r.after, yt(st(a, "afterLabel", this, o))), n.push(r)
        }), n
    }
    getAfterBody(t, e) {
        return zn(st(e.callbacks, "afterBody", this, t))
    }
    getFooter(t, e) {
        const {
            callbacks: s
        } = e, n = st(s, "beforeFooter", this, t), o = st(s, "footer", this, t), r = st(s, "afterFooter", this, t);
        let a = [];
        return a = gt(a, yt(n)), a = gt(a, yt(o)), a = gt(a, yt(r)), a
    }
    _createItems(t) {
    ...
    update(t, e) {
        ...
        if (!n.length) this.opacity !== 0 && (o = {
            ...
            const a = me[s.position].call(this, n, this._eventPosition);
            r = this._createItems(s), this.title = this.getTitle(r, s), this.beforeBody = this.getBeforeBody(r, s), this.body = this.getBody(r, s), this.afterBody = this.getAfterBody(r, s), this.footer = this.getFooter(r, s);
            const l = this._size = En(this, s),
                c = Object.assign({}, a, l),
                h = In(this.chart, s, c),
                d = Fn(s, c, h, this.chart);
    ...
    drawTitle(t, e, s) {
        ...
        let r, a, l;
        if (o) {
            const c = ie(s.rtl, this.x, this.width);
            for (t.x = Je(this, s.titleAlign, s), e.textAlign = c.textAlign(s.titleAlign), e.textBaseline = "middle", r = q(s.titleFont), a = s.titleSpacing, e.fillStyle = s.titleColor, e.font = r.string, l = 0; l < o; ++l) e.fillText(n[l], c.x(t.x), t.y + r.lineHeight / 2), t.y += r.lineHeight + a, l + 1 === o && (t.y += s.titleMarginBottom - a)
        }
    }
    ...
    drawBody(t, e, s) {
        ...
        let u = d.lineHeight,
            f = 0;
        const g = ie(s.rtl, this.x, this.width),
            p = function(S) {
                e.fillText(S, g.x(t.x + f), t.y + u / 2), t.y += u + o
            },
            m = g.textAlign(r);
        let b, x, y, v, _, M, k;
        for (e.textAlign = r, e.textBaseline = "middle", e.font = d.string, t.x = Je(this, m, s), e.fillStyle = s.bodyColor, z(this.beforeBody, p), f = a && m !== "right" ? r === "center" ? c / 2 + h : c + 2 + h : 0, v = 0, M = n.length; v < M; ++v) {
            for (b = n[v], x = this.labelTextColors[v], e.fillStyle = x, z(b.before, p), y = b.lines, a && y.length && (this._drawColorBox(e, t, v, g, s), u = Math.max(d.lineHeight, l)), _ = 0, k = y.length; _ < k; ++_) p(y[_]), u = d.lineHeight;
            z(b.after, p)
        }
    ...
    drawFooter(t, e, s) {
        ...
        let r, a;
        if (o) {
            const l = ie(s.rtl, this.x, this.width);
            for (t.x = Je(this, s.footerAlign, s), t.y += s.footerMarginTop, e.textAlign = l.textAlign(s.footerAlign), e.textBaseline = "middle", r = q(s.footerFont), e.fillStyle = s.footerColor, e.font = r.string, a = 0; a < o; ++a) e.fillText(n[a], l.x(t.x), t.y + r.lineHeight / 2), t.y += r.lineHeight + s.footerSpacing
        }
    }
    ...
    _updateAnimationTarget(t) {
        const e = this.chart,
            ...
            o = s && s.y;
        if (n || o) {
            const r = me[t.position].call(this, this._active, this._eventPosition);
            if (!r) return;
            const a = this._size = En(this, t),
    ...
    draw(t) {
        ...
        e.enabled && a && (t.save(), t.globalAlpha = s, this.drawBackground(o, t, n, e), Mo(t, e.textDirection), o.y += r.top, this.drawTitle(o, t, e), this.drawBody(o, t, e), this.drawFooter(o, t, e), So(t, e.textDirection), t.restore())
    }
    getActiveElements() {
        return this._active || []
    }
    ...
    _positionChanged(t, e) {
        const {
            ...
            caretY: n,
            options: o
        } = this, r = me[o.position].call(this, t, e);
...
var yd = {
        ...
        afterDraw(i) {
            ...
            if (t && t._willRender()) {
                ...
                if (i.notifyPlugins("beforeTooltipDraw", Fe(Ie({}, e), {
                        cancelable: !0
                    })) === !1) return;
...
const wd = (i, t, e, s) => (typeof t == "string" ? (e = i.push(t) - 1, s.unshift({
    index: e,
    label: t
})) : isNaN(t) && (e = null), e);
...
function kd(i, t, e, s) {
    const n = i.indexOf(t);
    if (n === -1) return wd(i, t, e, s);
    const o = i.lastIndexOf(t);
    return n !== o ? e : n
}
const Md = (i, t) => i === null ? null : G(Math.round(i), 0, t);
...
class Ji extends Jt {
    ...
    parse(t, e) {
        if (E(t)) return null;
        const s = this.getLabels();
        return e = isFinite(e) && s[e] === t ? e : kd(s, t, A(e, t), this._addedLabels), Md(e, s.length - 1)
    }
    determineDataLimits() {
        const {
            minDefined: t,
...
w(Ji, "id", "category"), w(Ji, "defaults", {
    ticks: {
        callback: Nn
    }
});
...
function Sd(i, t) {
    ...
    C = Math.ceil(m / _) - Math.floor(p / _), C > g && (_ = Rs(C * _ / g / f) * f), E(l) || (M = Math.pow(10, l), _ = Math.ceil(_ * M) / M), n === "ticks" ? (k = Math.floor(p / _) * _, S = Math.ceil(m / _) * _) : (k = p, S = m), b && x && o && xa((a - r) / o, _ / 1e3) ? (C = Math.round(Math.min((a - r) / _, h)), _ = (a - r) / C, k = r, S = a) : y ? (k = b ? r : k, S = x ? a : S, C = c - 1, _ = (S - k) / C) : (C = (S - k) / _, _e(C, Math.round(C), _ / 1e3) ? C = Math.round(C) : C = Math.ceil(C));
    const D = Math.max(Es(_), Es(k));
    M = Math.pow(10, E(l) ? D : l), k = Math.round(k * M) / M, S = Math.round(S * M) / M;
    let O = 0;
    for (b && (u && k !== r ? (e.push({
            value: r
        }), k < r && O++, _e(Math.round((k + O * _) * M) / M, r, Wn(r, v, i)) && O++) : k < r && O++); O < C; ++O) {
        const T = Math.round((k + O * _) * M) / M;
        if (x && T > a) break;
        e.push({
            value: T
        })
    }
    return x && u && S !== a ? e.length && _e(e[e.length - 1].value, a, Wn(a, v, i)) ? e[e.length - 1].value = a : e.push({
        value: a
    }) : (!x || S === a) && e.push({
        value: S
    }), e
...
class mi extends Jt {
    ...
    buildTicks() {
        ...
        const n = {
            ...
            o = this._range || this,
            r = Sd(n, o);
        return t.bounds === "ticks" && ro(r, this, "value"), t.reverse ? (r.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), r
    }
    configure() {
        const t = this.ticks;
        let e = this.min,
...
w(Zi, "id", "linear"), w(Zi, "defaults", {
    ticks: {
        callback: xi.formatters.numeric
    }
});
const Oe = i => Math.floor(Ot(i)),
    Wt = (i, t) => Math.pow(10, Oe(i) + t);
...
function Pd(i, {
    ...
    let d = Math.floor((c - h) / Math.pow(10, o)),
        u = ot(i.min, Math.round((l + h + d * Math.pow(10, o)) * r) / r);
    for (; u < e;) s.push({
        value: u,
        major: Vn(u),
        significand: d
...
class Qi extends Jt {
    ...
    parse(t, e) {
        const s = mi.prototype.parse.apply(this, [t, e]);
        if (s === 0) {
            this._zero = !0;
            return
        }
    ...
    determineDataLimits() {
        ...
        this.min = U(t) ? Math.max(0, t) : null, this.max = U(e) ? Math.max(0, e) : null, this.options.beginAtZero && (this._zero = !0), this._zero && this.min !== this._suggestedMin && !U(this._userMin) && (this.min = t === Wt(this.min, 0) ? Wt(this.min, -1) : Wt(this.min, 0)), this.handleTickRangeOptions()
    }
    handleTickRangeOptions() {
        const {
            minDefined: t,
        ...
        const o = a => s = t ? s : a,
            r = a => n = e ? n : a;
        s === n && (s <= 0 ? (o(1), r(10)) : (o(Wt(s, -1)), r(Wt(n, 1)))), s <= 0 && o(Wt(n, -1)), n <= 0 && r(Wt(s, 1)), this.min = s, this.max = n
    }
    buildTicks() {
        const t = this.options,
            e = {
            ...
            s = Pd(e, this);
        return t.bounds === "ticks" && ro(s, this, "value"), t.reverse ? (s.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), s
    }
    getLabelForValue(t) {
    ...
    getPixelForValue(t) {
        return (t === void 0 || t === 0) && (t = this.min), t === null || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (Ot(t) - this._startValue) / this._valueRange)
    }
    getValueForPixel(t) {
...
w(Qi, "id", "logarithmic"), w(Qi, "defaults", {
    ticks: {
...
function ts(i) {
    ...
    if (t.display && i.display) {
        ...
        return A(t.font && t.font.size, j.font.size) + e.height
    }
    return 0
}
...
function Od(i) {
    const t = {
        ...
        a = r.centerPointLabels ? H / o : 0;
    for (let l = 0; l < o; l++) {
        const c = r.setContext(i.getPointLabelContext(l));
        n[l] = c.padding;
        const h = i.getPointPosition(l, i.drawingArea + n[l], a),
            d = q(c.font),
            u = Dd(i.ctx, d, i._pointLabels[l]);
        s[l] = u;
        const f = rt(i.getIndexAngle(l) + a),
            g = Math.round(as(f)),
            p = Hn(g, h.x, u.w, 0, 180),
            m = Hn(g, h.y, u.h, 90, 270);
        Ad(e, t, f, p, m)
    }
...
function Rd(i, t, e) {
    ...
    for (let h = 0; h < n; h++) {
        ...
        const d = Td(i, h, l);
        s.push(d), a === "auto" && (d.visible = Ld(d, c), d.visible && (c = d))
    }
    return s
}
...
function Jo(i, t, e, s) {
    ...
    if (e) n.arc(i.xCenter, i.yCenter, t, 0, $);
    else {
...
function Nd(i, t, e, s, n) {
    ...
    !r && !s || !a || !l || e < 0 || (o.save(), o.strokeStyle = a, o.lineWidth = l, o.setLineDash(n.dash || []), o.lineDashOffset = n.dashOffset, o.beginPath(), Jo(i, e, r, s), o.closePath(), o.stroke(), o.restore())
}
...
class be extends mi {
    ...
    setDimensions() {
        const t = this._padding = Q(ts(this.options) / 2),
    ...
    generateTickLabels(t) {
        mi.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map((e, s) => {
    ...
    fit() {
        const t = this.options;
        t.display && t.pointLabels.display ? Od(this) : this.setCenterPoint(0, 0, 0, 0)
    }
    ...
    drawBackground() {
        ...
        if (t) {
            const s = this.ctx;
            s.save(), s.beginPath(), Jo(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length), s.closePath(), s.fillStyle = t, s.fill(), s.restore()
        }
    }
    drawGrid() {
        const t = this.ctx,
        ...
        let a, l, c;
        if (e.pointLabels.display && Bd(this, r), n.display && this.ticks.forEach((h, d) => {
...
w(be, "id", "radialLinear"), w(be, "defaults", {
    display: !0,
    animate: !0,
    position: "chartArea",
    angleLines: {
...
function Yn(i, t) {
    ...
    let r = t;
    return typeof s == "function" && (r = s(r)), U(r) || (r = typeof s == "string" ? e.parse(r, s) : e.parse(r)), r === null ? null : (n && (r = n === "week" && (se(o) || o === !0) ? e.startOf(r, "isoWeek", o) : e.startOf(r, n)), +r)
}
...
function Un(i, t, e, s) {
    ...
    for (let o = nt.indexOf(i); o < n - 1; ++o) {
        ...
        if (r.common && Math.ceil((e - t) / (a * r.size)) <= s) return nt[o]
    }
    return nt[n - 1]
}
...
function Vd(i, t, e, s, n) {
    for (let o = nt.length - 1; o >= nt.indexOf(e); o--) {
        const r = nt[o];
        if (wi[r].common && i._adapter.diff(n, s, r) >= t - 1) return r
    }
...
class Ae extends Jt {
    ...
    init(t, e = {}) {
        const s = t.time || (t.time = {}),
            n = this._adapter = new Jl._date(t.adapters.date);
        n.init(e), xe(s.displayFormats, n.formats()), this._parseOpts = {
            parser: s.parser,
            round: s.round,
    ...
    buildTicks() {
        ...
        const o = this.min,
            r = this.max,
            a = wa(n, o, r);
        return this._unit = e.unit || (s.autoSkip ? Un(e.minUnit, this.min, this.max, this._getLabelCapacity(o)) : Vd(this, a.length, e.minUnit, this.min, this.max)), this._majorUnit = !s.major.enabled || this._unit === "year" ? void 0 : $d(this._unit), this.initOffsets(n), t.reverse && a.reverse(), Kn(this, a, this._majorUnit)
    }
    afterAutoSkip() {
    ...
    _generate() {
        const t = this._adapter,
            ...
            n = this.options,
            o = n.time,
            r = o.unit || Un(o.minUnit, e, s, this._getLabelCapacity(e)),
            a = A(n.ticks.stepSize, 1),
        ...
        for (u = d, f = 0; u < s; u = +t.add(u, a, r), f++) Xn(h, u, g);
        return (u === s || n.bounds === "ticks" || f === 1) && Xn(h, u, g), Object.keys(h).sort(jn).map(p => +p)
    }
    getLabelForValue(t) {
    ...
    _getLabelCapacity(t) {
        const e = this.options.time,
            ...
            o = this._tickFormatFunction(t, 0, Kn(this, [t], this._majorUnit), n),
...
w(es, "id", "timeseries"), w(es, "defaults", Ae.defaults);
...
const Yd = [Gl, Ch, vd, jd];
wt.register(...Yd);
const Ud = "/modules/wallet2/assets/solscan-3dd6dda6.png",
    Xd = "/modules/wallet2/assets/coinmarketcap-9dd858cd.png",
    Kd = "/modules/wallet2/assets/coingecko-bf494a63.png",
    qd = "/modules/wallet2/assets/gmgn-d1ead7fa.png",
    Gd = "/modules/wallet2/assets/okx-5d6220e8.png";
var Jd = it('<div class="text-secondary size-8 center grow">'),
    Zd = it('<div class="flex justify-between gap-1 items-start"><div class=flex-1></div><div class="flex items-center">'),
    Qd = it('<div class="flex justify-between"><div class="flex flex-col flex-1 items-center rounded-lg px-3 py-3 w-fit bg-[#f4f4f4] md:px-18 dark:bg-[#0000000D]"><div class="w-32 flex justify-center"><canvas width=60 height=60></canvas></div><div class="mb-1 flex flex-col flex-nowrap justify-center items-center gap-1 text-ssecondary w-full pt-1 sm:flex-row"><span class="text-brand text-nowrap leading-normal"></span><span class="font-semibold leading-tight self-center text-nowrap"></span></div></div><div class="flex flex-col flex-1 justify-center ml-5 items-start space-y-1 md:ml-10 lg:relative lg:space-y-2"><div class="flex flex-col justify-center"><div class="flex items-center text-brand"><div class="rounded-full bg-brand mr-1 h-2 w-2"></div><span class=mr-1.5></span></div></div><div class="flex flex-col justify-center"><div class="mb-1 flex items-center text-error"><div class="rounded-full mr-1 h-2 w-2 bg-[#ff0101]"></div><span class=mr-1.5></span></div></div><div class="flex flex-col justify-center"><div class="mb-1 flex items-center text-warning"><div class="rounded-full mr-1 h-2 w-2 bg-[#FF9820]"></div><span class=mr-1.5>'),
    tu = it('<div class="grid gap-2 grid-cols-1 items-stretch lg:grid-cols-2"><div class="flex flex-wrap gap-2"><div class="flex flex-col bg-layer4 p-2 rounded-lg w-[calc(50%-8px)]"><div class="mb-1 flex justify-between items-center text-brand"><div class="flex items-center"><span class=text-sm></span></div><div class="text-sm font-tertiary overflow-hidden break-words text-tertiary"></div></div></div><div class="flex flex-col bg-layer4 p-2 rounded-lg w-[calc(50%-8px)]"><div class="mb-1 flex justify-between items-center text-brand"><div class="flex items-center"><span class=text-sm></span></div><div class="text-sm font-tertiary overflow-hidden break-words text-tertiary"></div></div></div><div class="flex flex-col bg-layer4 p-2 rounded-lg w-[calc(50%-8px)]"><div class="mb-1 flex justify-between items-center text-brand"><div class="flex items-center"><span class=text-sm></span></div><div class="text-sm font-tertiary overflow-hidden break-words text-tertiary"></div></div></div><div class="flex flex-col bg-layer4 p-2 rounded-lg w-[calc(50%-8px)]"><div class="mb-1 flex justify-between items-center text-brand"><div class="flex items-center"><span class=text-sm></span></div><div class="text-sm font-tertiary overflow-hidden break-words text-tertiary">'),
    eu = it('<div class="bg-layer4 rounded-lg flex items-center py-4 justify-center p-2 flex-wrap gap-3 lg:justify-around lg:py-4"><a href=https://solscan.io/token/BCNT4t3rv5Hva8RnUtJUJLnxzeFAabcYp8CghC1SmWin><img class="w-36 lg:w-40"></a><a href=https://coinmarketcap.com/currencies/bcgame-coin/><img class=w-44></a><a href=https://www.okx.com/web3/detail/501/BCNT4t3rv5Hva8RnUtJUJLnxzeFAabcYp8CghC1SmWin><img class="w-20 lg:w-24"></a><a href=https://www.coingecko.com/en/coins/bc-token><img class="w-36 lg:w-40"></a><a href="https://gmgn.ai/sol/token/BCNT4t3rv5Hva8RnUtJUJLnxzeFAabcYp8CghC1SmWin?tab=activity"><img class="w-32 lg:w-36">'),
    Te = it("<div>"),
    bi = it("<br>"),
    Zo = it("<a href=https://solscan.io/token/BCNT4t3rv5Hva8RnUtJUJLnxzeFAabcYp8CghC1SmWin class=underline>");
const Yt = "$BC",
    Bi = {
        supply: {
            totalSupply: 0,
...
function mu() {
    ...
    const i = is(),
        [t] = li(i(), () => ze(this, null, function*() {
            ...
            initialValue: Bi.supply
        });
    let e;
    ur(() => {
        t().totalSupply && new wt(e, {
            type: "doughnut",
            data: {
                datasets: [{
                    data: [t().circulatingTotal, t().burntTotal, t().lockTotal],
                    backgroundColor: ["rgba(36, 238, 137, 1)", "rgba(252, 60, 60, 1)", "rgba(255, 152, 32, 1)"],
                    borderColor: ["rgba(36, 238, 137, 1)", "rgba(252, 60, 60, 1)", "rgba(255, 152, 32, 1)"],
                    hoverOffset: 1,
                    borderAlign: "inner"
                }]
            },
    ...
    const [s] = li(i(), nu, {
        initialValue: Bi.statistic
    });
    return [I(vr, {
        class: "bg-gradient-to-tl from-[#24EE8900] from-60% via-[#24EE891A] via-80% to-[#24EE894D] to-100% sm:h-100"
    }), (() => {
        var n = tu(),
            o = n.firstChild,
            r = o.firstChild,
            ...
            C = k.nextSibling;
        return P(n, I(Jn, {
            class: "relative flex-col text-sm font-extrabold gap-3 pt-1",
            get children() {
                return [(() => {
                    var D = Zd(),
                        O = D.firstChild,
                    ...
                    return P(T, I(br, {
                        ...
                        get description() {
                            return [(() => {
                                var R = Te();
                                return P(R, () => B("This chart tracks the amount of __COIN__ supply circulating, burnt or locked.", {
                                    COIN: Yt
                                })), R
                            })(), bi(), (() => {
                                var R = Te();
                                return P(R, () => B("Circulating supply is the amount of __COIN__ that is free floating and available to users and on the market. Burnt supply is the total amount of __COIN__ burnt, forever reducing the total supply of __COIN__. Finally, the locked supply is the tokens that are vested, or not on the market.", {
                                    COIN: Yt
                                })), R
                            })(), bi(), (() => {
                                var R = Zo();
                                return P(R, () => B("For more details")), R
                            })()]
                        },
                        get children() {
                            var R = Jd();
                            return ar(R, "click", Ut.mobile ? iu : void 0, !0), P(R, I(Cr, {})), R
                        }
                    })), D
                })(), (() => {
                    var D = Qd(),
                        ...
                        er = tr.nextSibling,
                        vs = e;
                    return typeof vs == "function" ? lr(vs, R) : e = R, P(F, () => B("__COIN__ Supply", {
                        COIN: Yt
                    })), P(N, () => B("(Max. Supply)")), P(O, I(lt, {
                        class: "text-base leading-tight",
                        get children() {
                            return `${Qt(t().totalSupply,"BC")} BC`
                        }
                    }), null), P(Zt, () => B("Circulating")), P(K, I(lt, {
                        get children() {
                            return `${re(t().circulatingRate*100)}%`
                        }
                    }), null), P(et, I(lt, {
                        class: "text-base font-extrabold",
                        get children() {
                            return `${Qt(t().circulatingTotal,"BC")} BC`
                        }
                    }), null), P(Ft, () => B("Burnt")), P(Pt, I(lt, {
                        get children() {
                            return `${re(t().burntRate*100)}%`
                        }
                    }), null), P(ut, I(lt, {
                        class: "text-base font-extrabold",
                        get children() {
                            return `${Qt(t().burntTotal,"BC")} BC`
                        }
                    }), null), P(er, () => B("Locked")), P(ys, I(lt, {
                        get children() {
                            return `${re(t().lockRate*100)}%`
                        }
                    }), null), P(ft, I(lt, {
                        class: "text-base font-extrabold",
                        get children() {
                            return `${Qt(t().lockTotal,"BC")} BC`
                        }
                    }), null), D
                })()]
            }
            ...
            class: "mr-0.5"
        }), c), P(c, () => B("Total Wager")), P(h, () => B("Last 24h")), P(r, I(lt, {
            class: "text-sm font-extrabold mt-2 overflow-hidden break-words ml-0.5",
            get children() {
                return Qt(s().totalWager)
            }
        }), null), P(f, I(Dr, {
            class: "mr-0.5"
        }), g), P(g, () => B("Online")), P(p, () => B("Last 24h")), P(d, I(lt, {
            class: "text-sm font-extrabold mt-2 overflow-hidden break-words ml-0.5",
            get children() {
                return re(s().onlinePlays)
            }
        }), null), P(x, I(Or, {
            class: "mr-0.5"
        }), y), P(y, () => B("Bets")), P(v, () => B("Last 24h")), P(m, I(lt, {
            class: "text-sm font-extrabold mt-2 overflow-hidden break-words ml-0.5",
            get children() {
                return re(s().totalBetCount)
            }
        }), null), P(k, I(Ar, {
            class: "mr-0.5"
        }), S), P(S, () => B("Won Amount")), P(C, () => B("Last 24h")), P(_, I(lt, {
            class: "text-sm font-extrabold mt-2 overflow-hidden break-words ml-0.5",
            get children() {
                return Qt(s().totalWin, "USD")
            }
        }), null), n
    })(), (() => {
        var n = eu(),
            ...
            f = d.nextSibling,
            g = f.firstChild;
        return Ht(r, "src", Ud), Ht(l, "src", Xd), Ht(h, "src", Gd), Ht(u, "src", Kd), Ht(g, "src", qd), n
    })(), I(Nr, {
        class: "mb-4"
    })]
}
const iu = () => {
        xr.push(() => I(_r, {
            ...
            get children() {
                return [(() => {
                    var i = Te();
                    return P(i, () => B("This chart tracks the amount of __COIN__ supply circulating, burnt or locked.", {
                        COIN: Yt
                    })), i
                })(), bi(), (() => {
                    var i = Te();
                    return P(i, () => B("Circulating supply is the amount of __COIN__ that is free floating and available to users and on the market. Burnt supply is the total amount of __COIN__ burnt, forever reducing the total supply of __COIN__. Finally, the locked supply is the tokens that are vested, or not on the market.", {
                        COIN: Yt
                    })), i
                })(), bi(), (() => {
                    var i = Zo();
                    return P(i, () => B("For more details")), i
                })()]
            }
        }))
    },
...
function su() {
    return ze(this, null, function*() {
        return yield Qo.get("/bctrade/forward/api/coin/token/statistics")
    })
}

function nu() {
    return ze(this, null, function*() {
        return yield Qo.get("/activity/bc-token/dashboard/")
    })
}
