...
import {
    b as co
} from "./api-0baceaaa.js";
import "./useCommonPostPR-b629c60a.js";
/*!
 * matrix 3.13.0
 * https://gsap.com
 *
 ...
 */
var De, He, Ut, Et, rt, vt, St, ft, de = "transform",
    $t = de + "Origin",
    Ei, Mi = function(t) {
    ...
    Yt = function c(t, o) {
        if (t.parentNode && (De || Mi(t))) {
            ...
            return o && (i ? (vt || (vt = c(t)), p.setAttribute("width", .01), p.setAttribute("height", .01), p.setAttribute("transform", "translate(" + f + "," + a + ")"), vt.appendChild(p)) : (rt || (rt = c(t), rt.style.cssText = y), p.style.cssText = y + "width:0.1px;height:0.1px;top:" + a + "px;left:" + f + "px", rt.appendChild(p))), p
        }
    ...
    mo = function(t, o) {
        var i = qt(t),
            ...
            y, p, h, _, v, e;
        if (t === He) return t;
        if (s.length || s.push(Yt(t, 1), Yt(t, 2), Yt(t, 3)), y = i ? vt : rt, i) r ? (h = yo(t), _ = -h.e / h.a, v = -h.f / h.d, p = St) : t.getBBox ? (h = t.getBBox(), p = t.transform ? t.transform.baseVal : {}, p = p.numberOfItems ? p.numberOfItems > 1 ? xo(p) : p.getItem(0).matrix : St, _ = p.a * h.x + p.c * h.y, v = p.b * h.x + p.d * h.y) : (p = new $e, _ = v = 0), o && t.tagName.toLowerCase() === "g" && (_ = v = 0), (r ? i : f).appendChild(y), y.setAttribute("transform", "matrix(" + p.a + "," + p.b + "," + p.c + "," + p.d + "," + (p.e + _) + "," + (p.f + v) + ")");
        else {
            if (_ = v = 0, Ei)
                for (p = t.offsetParent, h = t; h && (h = h.parentNode) && h !== p && h.parentNode;)(He.getComputedStyle(h)[de] + "").length > 4 && (_ = h.offsetLeft, v = h.offsetTop, h = 0);
            if (e = He.getComputedStyle(t), e.position !== "absolute" && e.position !== "fixed")
                for (p = t.offsetParent; f && f !== p;) _ += f.scrollLeft || 0, v += f.scrollTop || 0, f = f.parentNode;
            h = y.style, h.top = t.offsetTop - v + "px", h.left = t.offsetLeft - _ + "px", h[de] = e[de], h[$t] = e[$t], h.position = e.position === "fixed" ? "fixed" : "absolute", a.appendChild(y)
        }
        return y
    },
    ...
    $e = function() {
        ...
        return t.inverse = function() {
            ...
            var r = this.a,
                ...
                b = i.e,
                M = i.f;
            return Ot(this, h * r + v * f, h * s + v * a, _ * r + e * f, _ * s + e * a, y + b * r + M * f, p + b * s + M * a)
        }, t.clone = function() {
            ...
            var s = i.x,
                ...
                _ = this.e,
                v = this.f;
            return r.x = s * a + f * p + _ || 0, r.y = s * y + f * h + v || 0, r
        }, c
    }();
...
function Fe(c, t, o, i) {
    ...
    var r = uo(c),
        ...
        _ = a.parentNode,
        v = !i && go(c),
        e = new $e((p.left - y.left) / 100, (p.top - y.top) / 100, (h.left - y.left) / 100, (h.top - y.top) / 100, y.left + (v ? 0 : ho()), y.top + (v ? 0 : po()));
...
var D, Y, te, pe, Ee, At, Se, zt, lt, Xe, ki, Vt, pt, Zt, st, ce, at, bt, Li, Gt, Dt = 0,
    Ni = function() {
    ...
    Po = function(t, o) {
        ...
        return t === o ? {
            ...
            x: s,
            y
        }), s = Math.min(h.x, _.x, v.x, e.x), a = Math.min(h.y, _.y, v.y, e.y), {
            left: s,
            top: a,
            width: Math.max(h.x, _.x, v.x, e.x) - s,
            height: Math.max(h.y, _.y, v.y, e.y) - a
        })
    },
    ...
    Co = function c(t) {
        var o;
        return !t || !t.getAttribute || t === Ee ? !1 : (o = t.getAttribute("data-clickable")) === "true" || o !== "false" && (bo.test(t.nodeName + "") || t.getAttribute("contentEditable") === "true") ? !0 : c(t.parentNode)
    },
    _t = function(t, o) {
    ...
    Oi, Kt, Lo = function(t, o) {
        ...
        Oi && o.force3D !== !1 ? (we = "translate3d(", ge = "px,0px)") : ut && (we = "translate(", ge = "px)"), this.scrollTop = function(P, j) {
            ...
            P = -P, P < 0 ? (a = P - .5 | 0, P = 0) : P > e ? (a = P - e | 0, P = e) : a = 0, (a || C) && (this._skip || (r[ut] = we + -a + "px," + -f + ge), a + v >= 0 && (r.paddingRight = a + v + "px")), t.scrollLeft = P | 0, p = t.scrollLeft
            ...
            P = -P, P < 0 ? (f = P - .5 | 0, P = 0) : P > b ? (f = P - b | 0, P = b) : f = 0, (f || C) && (this._skip || (r[ut] = we + -a + "px," + -f + ge)), t.scrollTop = P | 0, y = t.scrollTop
    ...
    Je = function(c) {
        ...
        function t(o, i) {
            ...
            var s = (i.type || "x,y").toLowerCase(),
                ...
                v = i.minimumMovement || 2,
                e = pi(r),
                b = Xe(i.trigger || i.handle || o),
                M = {},
                A = 0,
                N = !1,
                ...
                ve, T, xe, ye, U, V, Re, Jt, jt, B, O, G, W, gt, ie, je, K, Mt, Me, Pe, Ye, et, q, L, ei, oe, se, Pt, Ct, ti, ee, ii, xt, oi = function(n) {
                ...
                Ai = function(n, u, l, d, g, x, S) {
                    return x = x && x < Be ? x * x : Be, Ne(n) ? function(m) {
                        var X = e.isPressed ? 1 - e.edgeResistance : 1,
                            ...
                            R = m.y,
                            F, J, be;
                        return m.x = E = E > l ? l + (E - l) * X : E < u ? u + (E - u) * X : E, m.y = R = R > g ? g + (R - g) * X : R < d ? d + (R - d) * X : R, F = n.call(e, m), F !== m && (m.x = F.x, m.y = F.y), S !== 1 && (m.x *= S, m.y *= S), x < Be && (J = m.x - E, be = m.y - R, J * J + be * be > x && (m.x = E, m.y = R)), m
                    } : nt(n) ? function(m) {
                        for (var X = n.length, E = 0, R = Be, F, J, be, ne; --X > -1;) be = n[X], F = be.x - m.x, J = be.y - m.y, ne = F * F + J * J, ne < R && (E = X, R = ne);
                        return R <= x ? n[E] : m
                    } : function(m) {
                        return m
                    }
                ...
                it = function(n, u) {
                    var l;
                    if (!ve || e.isPressed || !n || (n.type === "mousedown" || n.type === "pointerdown") && !u && Le() - I < 30 && pt[e.pointerEvent.type]) {
                        ee && n && ve && re(n);
                        return
                    }
                    if (ei = tt(), xt = !1, e.pointerEvent = n, pt[n.type] ? (q = ~n.type.indexOf("touch") ? n.currentTarget || n.target : k, Q(q, "touchend", ae), Q(q, "touchmove", Ae), Q(q, "touchcancel", ae), Q(k, "touchstart", wi)) : (q = null, Q(k, "mousemove", Ae)), se = null, (!bt || !q) && (Q(k, "mouseup", ae), n && n.target && Q(n.target, "mouseup", ae)), et = j.call(e, n.target) && i.dragClickables === !1 && !u, et) {
                        Q(n.target, "change", ae), H(e, "pressInit", "onPressInit"), H(e, "press", "onPress"), _t(b, !0), ee = !1;
                        return
                    }
                ...
                Ae = function(n) {
                    ...
                    if (q && oe && !se && (le.x = n.pageX - (_e ? qe(k) : 0), le.y = n.pageY - (_e ? Ue(k) : 0), L && L.apply(le, le), d = le.x, g = le.y, S = Math.abs(d - xe), m = Math.abs(g - ye), (S !== m && (S > v || m > v) || st && oe === se) && (se = S > m && h ? "x" : "y", oe && se !== oe && Q(Y, "touchforcechange", re), e.vars.lockAxisOnTouchScroll !== !1 && h && _ && (e.lockedAxis = se === "x" ? "y" : "x", Ne(e.vars.onLockAxis) && e.vars.onLockAxis.call(e, u)), st && oe === se))) {
                        ae(u);
                        return
                ...
                ae = function w(n, u) {
                    ...
                    var l = n,
                        ...
                        S, m, X, E, R;
                    if (q ? (z(q, "touchend", w), z(q, "touchmove", Ae), z(q, "touchcancel", w), z(k, "touchstart", wi)) : z(k, "mousemove", Ae), z(Y, "touchforcechange", re), (!bt || !q) && (z(k, "mouseup", w), n && n.target && z(n.target, "mouseup", w)), K = !1, d && (A = gi = Le(), e.isDragging = !1), mi(me), et && !g) {
                        n && (z(n.target, "change", w), e.pointerEvent = l), _t(b, !1), H(e, "release", "onRelease"), H(e, "click", "onClick"), et = !1;
                        return
                    }
                    for (m = b.length; --m > -1;) It(b[m], "cursor", i.cursor || (i.cursor !== !1 ? at : null));
                    if (Dt--, n) {
            ...
            return Mt = t.get(o), Mt && Mt.kill(), r.startDrag = function(w, n) {
                ...
                var x = e.x,
                    S = e.y;
                return ni(!n), w ? e.applyBounds() : (K && u && me(!0), Oe(!0)), n && (ot(e.pointerX, e.pointerY), K && me(!0)), e.isPressed && !n && (h && Math.abs(x - e.x) > .01 || _ && Math.abs(S - e.y) > .01 && !a) && yt(), e.autoScroll && (Bt(o.parentNode, e.isDragging), N = e.isDragging, me(!0), vi(o, mt), _i(o, mt)), e
            }, r.enable = function(w) {
                var n = {
                        lazy: !0
                    },
                ...
                if (i.cursor !== !1 && (n.cursor = i.cursor || at), D.utils.checkPrefix("touchCallout") && (n.touchCallout = "none"), w !== "soft") {
                    for (xi(b, h === _ ? "none" : i.allowNativeTouchScrolling && o.scrollHeight === o.clientHeight == (o.scrollWidth === o.clientHeight) || i.allowEventDefault ? "manipulation" : h ? "pan-y" : "pan-x"), l = b.length; --l > -1;) d = b[l], bt || Q(d, "mousedown", it), Q(d, "touchstart", it), Q(d, "click", ri, !0), D.set(d, n), d.getBBox && d.ownerSVGElement && h !== _ && D.set(d.ownerSVGElement, {
                ...
                return _i(o, mt), ve = !0, ce && w !== "soft" && ce.track(T || o, f ? "x,y" : a ? "rotation" : "top,left"), o._gsDragID = u = o._gsDragID || "d" + vo++, Ke[u] = e, T && (T.enable(), T.element._gsDragID = u), (i.bounds || a) && yt(), i.bounds && e.applyBounds(), e
            }, r.disable = function(w) {
                for (var n = e.isDragging, u = b.length, l; --u > -1;) It(b[u], "cursor", null);
                if (w !== "soft") {
                    for (xi(b, null), u = b.length; --u > -1;) l = b[u], It(l, "touchCallout", null), z(l, "mousedown", it), z(l, "touchstart", it), z(l, "click", ri, !0), z(l, "contextmenu", oi);
                    _t(b, !0), q && (z(q, "touchcancel", ae), z(q, "touchend", ae), z(q, "touchmove", Ae)), z(k, "mouseup", ae), z(k, "mousemove", Ae)
                }
                return vi(o, mt), ve = !1, ce && w !== "soft" && (ce.untrack(T || o, f ? "x,y" : a ? "rotation" : "top,left"), e.tween && e.tween.kill()), T && T.disable(), mi(me), e.isDragging = e.isPressed = et = !1, n && H(e, "dragend", "onDragEnd"), e
            }, r.enabled = function(w, n) {
                return arguments.length ? w ? e.enable(n) : e.disable(n) : ve
            }, r.kill = function() {
                return e.isThrowing = !1, e.tween && e.tween.kill(), e.disable(), D.set(b, {
        ...
        return t.register = function(i) {
            ...
            var f = Qe(i),
                ...
                v = f.width,
                e = f.height,
                b = a.left > h || a.right < p || a.top > _ || a.bottom < y,
                M, A, N;
            return b || !s ? !b : (N = (s + "").indexOf("%") !== -1, s = parseFloat(s) || 0, M = {
                left: Math.max(p, a.left),
                top: Math.max(y, a.top)
            }, M.width = Math.min(h, a.right) - M.left, M.height = Math.min(_, a.bottom) - M.top, M.width < 0 || M.height < 0 ? !1 : N ? (s *= .01, A = M.width * M.height, A >= v * e * s || A >= a.width * a.height * s) : M.width > s && M.height > s)
        }, t
    }(No);
Do(Je.prototype, {
    pointerX: 0,
            ...
            const a = ji(),
                ...
                _ = () => {
                    ...
                    const e = ((A = document.getElementsByClassName("page-header")[0]) == null ? void 0 : A.clientHeight) || (Ve.mobile ? 56 : 60) * Ve.remScale,
                        b = ((N = document.getElementsByClassName("tabbar")[0]) == null ? void 0 : N.clientHeight) || (Ve.mobile ? 72 : 10) * Ve.remScale,
                        M = (f == null ? void 0 : f.clientWidth) || 0;
                    return {
                        minX: -a.width + M + p + 2,
                        maxX: p,
                        minY: e,
                        maxY: a.height - e - b - 12 - h()
                    }
                };
            let v;
            return Wt(() => {
