...
class st {
    ...
    constructor(t, e = {}) {
        ...
        this.locale = t, this.formatter = new Intl.NumberFormat(t, e), this.options = this.formatter.resolvedOptions(), this.symbols = function(a, o, i, l) {
            ...
            let z = new Intl.NumberFormat(a, j($({}, i), {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2
                })).formatToParts(.001),
                s = (w = z.find(v => v.type === "decimal")) === null || w === void 0 ? void 0 : w.value,
...
function ct(r) {
    ...
    return C(U(o, i => {
        var l;
        a && (l = "assertive", A && A.clear(l), function(u, d = "assertive", w = Oe) {
            A || (A = new ut), A.announce(u, d, w)
        }(i != null ? i : "", "assertive"))
    })), m(F, f({
        as: "div",
        role: "spinbutton",
...
function X(r) {
    ...
    return C(() => B(t.registerDescription(e.id))), m(F, f({
        as: "div"
    }, () => t.dataset(), e))
}
...
function Y(r) {
    ...
    return C(() => {
        o() && B(t.registerErrorMessage(a.id))
    }), m(Ze, {
        get when() {
...
function q(r) {
    ...
    const e = R(),
        ...
        [a, o] = y(n, ["ref"]),
        i = tt(() => t, () => "label");
    return C(() => B(e.registerLabel(o.id))), m(F, f({
        as: "label",
        ref(l) {
            var u = k(d => t = d, a.ref);
...
function Ee(r) {
    ...
    return C(() => B(t.registerField(p(e.id)))), {
        fieldProps: {
            id: () => p(e.id),
...
function pe(r) {
    ...
    (z = a.onRawValueChange) == null || z.call(a, w(c()));
    const {
