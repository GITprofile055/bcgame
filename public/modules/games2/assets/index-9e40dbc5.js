...
var v1 = n('<textarea class="bg-layer3 h-36 p-2 mt-px rounded-xl focus:outline-none focus:ring-1 focus:ring-brand resize-none w-full border-third border"rows=3>'),
    ...
    b1 = n('<img class="size-full rounded-full">'),
...
function N1(p) {
    ...
    function t0(e) {
        ...
        const [a, o] = m(e.type ? (C = e.item) == null ? void 0 : C.content : ""), d = () => {
            ...
            const r = u + " ";
            q && (q.setRangeText(r), o(q.value), q.focus(), q.selectionStart = q.selectionEnd = (q.selectionStart || 0) + r.length)
        };
        return l(W0, {
            get title() {
                return Q(() => !!X.mobile)() ? (r = C1(), c = r.firstChild, t(r, l(y, {
            ...
            class: "!min-h-20",
            get children() {
                return [(r = v1(), r.addEventListener("change", c => o(c.target.value)), h0(c => q = c, r), B(() => J(r, "placeholder", s("Add a comment"))), B(() => r.value = a()), r), (u = L0(), t(u, l(p1, {
                    onChange: L
                }), null), t(u, l(Z, {
                    get when() {
                        return !X.mobile
    ...
    function s0(e, a) {
        return (o = L0()).$$click = d => {
            d.stopPropagation(), h(e), M(!1), j()
        }, t(o, a), B(d => {
            var L = "h-10 leading-10 text-center bg-layer5 rounded-md mx-1 " + (z() === e ? "selected" : ""),
    ...
    function q0(e) {
        ...
        return C = z1(), u = C.firstChild, r = u.firstChild, c = r.firstChild, W = c.nextSibling, l0 = W.nextSibling, T = r.nextSibling, _ = u.nextSibling, t(c, l(i0, {
            get href() {
                return `/user/profile/${e.item.userId}`
            },
            get children() {
                var b = b1();
                return B(() => J(b, "src", u0.avatar(e.item.userId, "s"))), b
            }
        })), t(W, () => e.item.userName), t(l0, () => z0(e.item.createTime, new Date)), t(T, l(y, {
            onClick: () => {
                E.login ? S.push(() => l(t0, {
                    get title() {
            ...
            onClick: () => (b => {
                ...
                E.login ? $().post(`/comment/like/${b?"undo":"do"}/`, n0).then(() => {
                    const R = b ? -1 : 1;
                    o(a() + R), L(!d())
            ...
            get children() {
                return l(i0, {
                    ...
                    get children() {
                        var b = M1();
                        return b.firstChild, t(b, () => e.item.replyUserName, null), b
                    }
                })
            }
        }), null), t(_, () => I0(e.item.content), null), C;
        var C, u, r, c, W, l0, T, _
    }

    function j0(e) {
        const [a, o] = m(e.item.likeCount), {
            user: d
        } = M0(), [L, C] = m(e.item.isCommentLike === 1), [u, r] = m([]), [c, W] = m(0), [l0, T] = m(!1), [_, b] = m(""), [n0, R] = m(!1), [C0, E0] = m(S0[0].value), P0 = K0(() => e.item.userId === d.userId && e.item.replyCount === 0 ? [{
            value: "edit",
            ...
            l0() || (T(!0), $().post("/comment/reply/list/", {
                ...
                v && (r(w => [...w, ...v.list]), W(v.total))
            }).catch(v => H(v)).finally(() => {
                T(!1)
            }))
        };
        return O = S1(), c0 = O.firstChild, r0 = c0.firstChild, a0 = r0.firstChild, o0 = a0.nextSibling, d0 = o0.nextSibling, K = r0.nextSibling, A = K.firstChild, y0 = c0.nextSibling, t(a0, l(i0, {
            get href() {
                return `/user/profile/${e.item.userId}`
            },
            get children() {
        ...
        })), t(o0, () => e.item.userName), t(r0, l(Q0, {
            get code() {
        ...
        }), d0), t(d0, () => z0(e.item.createTime, new Date)), t(K, l(y, {
            class: "p-0",
            onClick: () => {
                E.login ? S.push(() => l(t0, {
                    get title() {
            ...
            children: i => l(V0, {
                ...
                setSelectedOperateOption: b,
                onHandleClick: v => {
                    v.stopPropagation(), R(!1), (() => w0(this, null, function*() {
                        _() === "delete" && (yield S.confirm(() => s("Are you sure to delete this comment?"))) && $().post(`/comment/del/${e.item.commentId}/`, {}).then(() => {}).catch(w => H(w)).finally(() => {
                            j()
                            ...
                            return b0 = (w = I1()).firstChild, t(b0, () => s("Please choose the reporting reason:")), t(w, l(Y0, {
                                get value() {
                                    return C0()
                                },
                                get options() {
            ...
            get when() {
                return Q(() => e.item.replyCount > 0)() && u().length === 0
            },
            get children() {
                return l(y, {
            ...
            return t(o, () => s("Comments")), t(a, l(y, {
                ...
                get children() {
                    return l(y, {
                        ...
                        get children() {
                            return [Q(() => s("View More Comments")), g0()]
                        }
                    })
                }
            }), null), t(e, l(Z, {
