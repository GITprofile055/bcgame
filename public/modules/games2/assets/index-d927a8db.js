...
typeof document != "undefined" && (document.readyState !== "loading" ? R() : document.addEventListener("DOMContentLoaded", R));
var Ke = {
    border: "0",
    clip: "rect(0 0 0 0)",
    "clip-path": "inset(50%)",
...
var Ve = {
        ...
        disableBodyPointerEvents: function(e) {
            if (E() && !w) {
                const t = g(e);
                B = document.body.style.pointerEvents, t.body.style.pointerEvents = "none", w = !0
            }
        },
        restoreBodyPointerEvents: function(e) {
            if (E()) return;
            const t = g(e);
            t.body.style.pointerEvents = B, t.body.style.length === 0 && t.body.removeAttribute("style"), w = !1
        }
    },
...
export {
    Ie as A, De as B, Ve as C, ze as D, ne as E, je as F, Se as G, ge as H, me as I, he as J, Le as K, Ce as L, xe as M, x as N, be as O, Ue as P, pe as Q, ye as R, Ye as S, Ge as T, _e as _, Oe as a, Ne as b, qe as c, We as d, Pe as e, ve as f, g, re as h, Te as i, He as j, ee as k, Ae as l, Be as m, de as n, ke as o, Re as p, Me as q, te as r, Je as s, Ee as t, ce as u, Ke as v, se as w, v as x, we as y, Fe as z
};