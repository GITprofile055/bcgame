...
import "./game-434e4797.js";
import "./user-20d68319.js";
import "./utils-65805dbc.js";
import "./config-66839ee1.js";
...
function ze(t, n) {
    return m(this, null, function*() {
        return S(t, HTMLCanvasElement) ? function(e) {
            return m(this, null, function*() {
                const a = e.toDataURL();
                return a === "data:," ? e.cloneNode(!1) : K(a)
            })
            ...
            return m(this, null, function*() {
                if (e.currentSrc) {
                    const s = document.createElement("canvas"),
                        i = s.getContext("2d");
                    return s.width = e.clientWidth, s.height = e.clientHeight, i == null || i.drawImage(e, 0, 0, s.width, s.height), K(s.toDataURL())
                }
                const r = e.poster,
                    o = st(r);
                return K(yield it(r, o, a))
            })
        }(t, n) : S(t, HTMLIFrameElement) ? function(e, a) {
            return m(this, null, function*() {
                var r;
                try {
                    if (!((r = e == null ? void 0 : e.contentDocument) === null || r === void 0) && r.body) return yield Z(e.contentDocument.body, a, !0)
                } catch (o) {}
    ...
    return m(this, null, function*() {
        return e || !n.filter || n.filter(t) ? Promise.resolve(t).then(a => ze(a, n)).then(a => function(r, o, s) {
            return m(this, null, function*() {
                ...
                if (Qt(o)) return o;
                let c = [];
                return c = We(r) && r.assignedNodes ? L(r.assignedNodes()) : S(r, HTMLIFrameElement) && (!((i = r.contentDocument) === null || i === void 0) && i.body) ? L(r.contentDocument.body.childNodes) : L(((l = r.shadowRoot) !== null && l !== void 0 ? l : r).childNodes), c.length === 0 || S(r, HTMLVideoElement) || (yield c.reduce((d, h) => d.then(() => Z(h, s)).then(u => {
                    u && o.appendChild(u)
                }), Promise.resolve())), o
            })
...
function Xt(t, n, e) {
    return m(this, null, function*() {
        ...
        return function(o) {
            const s = [];
            return o.replace(Jt, (i, l, c) => (s.push(c), i)), s.filter(i => !at(i))
        }(a).reduce((o, s) => o.then(i => Ke(i, s, n, e)), Promise.resolve(a))
    })
}
...
function Zt(t, n) {
    return m(this, null, function*() {
        S(t, Element) && (yield function(e, a) {
            ...
            return m(this, null, function*() {
                const r = L(e.childNodes).map(o => Zt(o, a));
...
function Xe(t, n) {
    return m(this, null, function*() {
        ...
        return function(r) {
            return r.filter(o => o.type === CSSRule.FONT_FACE_RULE).filter(o => Kt(o.style.getPropertyValue("src")))
        }(a)
    })
}
...
function Ze(t, n) {
    return m(this, null, function*() {
        const e = yield Xe(t, n), a = function(r) {
            const o = new Set;
            return function s(i) {
...
function Ye(e) {
    return m(this, arguments, function*(t, n = {}) {
        const {
            width: a,
            height: r
        } = zt(t, n), o = yield Z(t, n, !0);
        return yield function(s, i) {
            return m(this, null, function*() {
                const l = i.fontEmbedCSS != null ? i.fontEmbedCSS : i.skipFonts ? null : yield Ze(s, i);
                if (l) {
...
function Yt(e) {
    return m(this, arguments, function*(t, n = {}) {
        const {
            width: a,
            height: r
        } = zt(t, n), o = yield Ye(t, n), s = yield K(o), i = document.createElement("canvas"), l = i.getContext("2d"), c = n.pixelRatio || function() {
            let u, y;
            try {
                y = process
            } catch (E) {}
...
function un(t) {
    ...
    const {
        ...
        import ("./QRcode-d0af5125.js"), ["assets/QRcode-d0af5125.js", "assets/manifest-47857305.js"])), te = () => {
        n && (d(!0), function(f) {
    ...
    return D(() => m(this, null, function*() {
        ...
        get children() {
            return [(() => {
                ...
                onChange: ee
            }), b), v(b, () => k("Don’t show this again for 30 days"), null), X(f => ve(g, _.mobile ? void 0 : {
...
function Ln() {
    D(() => {
        const t = ke();
        Pe(t, () => {
            Le(() => x(hn, {}), J || (J = document.createElement("div"), document.body.appendChild(J), J))
        })
    })
}
export {
