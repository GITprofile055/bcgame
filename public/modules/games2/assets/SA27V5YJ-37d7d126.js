...
function ze(e, r) {
    var n = typeof e;
    return !!(r = r == null ? Fe : r) && (n == "number" || n != "symbol" && Le.test(e)) && e > -1 && e % 1 == 0 && e < r
}
...
function Ke(e) {
    ...
    var r = e + "";
    return r == "0" && 1 / e == -Ze ? "-0" : r
}

function Qe(e, r, n) {
    for (var t = -1, o = (r = Ye(r, e)).length, u = !1; ++t < o;) {
        var s = Ke(r[t]);
        if (!(u = e != null && n(e, s))) break;
        e = e[s]
    }
    return u || ++t != o ? u : !!(o = e == null ? 0 : e.length) && $e(o) && ze(s, o) && (B(e) || Ue(e))
}
...
const z = e => ({
    ...
    Y = e => {
        const s = e,
            ...
            u = x(s, ["generalAmount", "groupAmount", "deducting", "amount"]);
        return N(p({}, u), {
            generalAmount: r,
            amount: o,
            deducting: t,
    ...
    or = W(() => {
        const {
            ...
            return N(p({}, z(r.activeCurrencyConfig)), {
                icon: a
            })
        }), T = C(() => {
            const a = m.setting.localeCurrencyName;
            return e.currencyV2[a] ? N(p({}, z(e.currencyV2[a])), {
                icon: a
            }) : {
                name: a,
                symbol: a,
        ...
        return I(() => {
            ...
            const a = ae(m.setting.currencyName),
                c = h[a],
                y = e.currencyV2[a];
            c && n("activeCurrency", Y(h[a])), y && n("activeCurrencyConfig", y)
        }), I(() => {
            Object.keys(h).length && n("currencies", Object.values(h).filter(g => g.display).map(g => Y(g)));
            const {
                amount: a,
                generalAmount: c,
                groupAmount: y
            ...
            isFiat: a => {
                let c = "";
                return typeof a == "string" ? c = a : L(a, "symbol") ? c = a.symbol : "currencyName" in a && (c = a.currencyName), [e.currencyName, e.aliasCurrencyName].some(y => y.toLowerCase() === c.toLowerCase())
            },
            findCurrency: a => {
                var y;
                let c = "";
                return typeof a == "string" && (c = a), L(a, "symbol") ? c = a.symbol : L(a, "currencyName") && (c = a.currencyName), ((y = r.currencies) == null ? void 0 : y.find(g => G(g.currencyName, c))) || null
            },
            findToken: j,
            resetToken: () => {
                v(!1);
...
const Z = e => typeof e == "boolean" ? "".concat(e) : e === 0 ? "0" : e,
    K = function() {
    ...
    br = (e, r) => n => {
        var t;
        if ((r == null ? void 0 : r.variants) == null) return K(e, n == null ? void 0 : n.class, n == null ? void 0 : n.className);
        const {
            variants: o,
            defaultVariants: u
...
function ir(e, r) {
    const [n, t] = w(Q(r == null ? void 0 : r()));
    return I(() => {
        var o;
        t(((o = e()) == null ? void 0 : o.tagName.toLowerCase()) || Q(r == null ? void 0 : r()))
    }), n
}
...
var yr = ie;
export {
    ie as B, gr as S, ar as a, P as b, br as c, B as d, Ue as e, ze as f, Ye as g, Qe as h, $e as i, Ee as j, $ as k, xe as l, ir as m, Xe as n, L as o, K as p, Ke as t, ur as u
};