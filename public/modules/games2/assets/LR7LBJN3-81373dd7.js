...
function E() {
    const e = function() {
        const t = {
            ...
            r = h(() => x ? t : n());
        return z(() => {
            p.size === 0 && window.addEventListener("languagechange", O), p.add(a), k(() => {
...
function X(e) {
    const {
        locale: t
    } = E(), n = h(() => t() + (e ? Object.entries(e).sort((a, r) => a[0] < r[0] ? -1 : 1).join() : ""));
    return h(() => {
        const a = n();
        let r;
...
export {
    N as $, A as a, W as b, B as c, X as d, E as u
};